...
function(a){b.removeClass("busy");a.success&&(b.html(a.result),$(".left").html(a.spisok))},"json"))},zayavZamerDtime=function(a){a=$.extend({day:"",hour:10,min:0},a);a='<table><tr><td><INPUT TYPE="hidden" id="zamer_day" value="'+a.day+'" /><td><INPUT TYPE="hidden" id="zamer_hour" value="'+a.hour+'" /><td> : <td><INPUT TYPE="hidden" id="zamer_min" value="'+a.min+'" /></table>';$(".zayav-zamer-dtime").html(a);$("#zamer_day")._calendar();$("#zamer_hour")._select({width:40,spisok:ZAMER_HOUR});$("#zamer_min")._select({width:40,
spisok:ZAMER_MIN});$("#zamer_duration")._select({width:100,spisok:ZAMER_DURATION})},zayavFindFast=function(){var a={op:"zayav_findfast",find:$.trim($("#find input").val())};$(".find-hide")[(a.find?"add":"remove")+"Class"]("dn");a.find?($("#mainLinks").addClass("busy"),$.post(AJAX_MAIN,a,function(a){$("#mainLinks").removeClass("busy");a.success&&($("#zayav .result").html(a.result),$("#zayav #spisok").html(a.spisok))},"json")):zayavSpisok()},zayavFilter=function(){return{op:"zayav_spisok",category:$("#zayav").attr("val"),
product:$("#product_id").val(),status:$("#status").val()}},zayavSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,zayavFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#zayav .result").html(a.result),$("#zayav #spisok").html(a.spisok))},"json")},dogovorCreate=function(a){function b(b){var d={id:DOG.id,zayav_id:ZAYAV.id,fio:$("#fio").val(),adres:$("#adres").val(),pasp_seria:$("#pasp_seria").val(),pasp_nomer:$("#pasp_nomer").val(),pasp_adres:$("#pasp_adres").val(),
pasp_ovd:$("#pasp_ovd").val(),pasp_data:$("#pasp_data").val(),nomer:$("#nomer").val(),data_create:$("#data_create").val(),sum:$("#sum").val(),avans:$("#avans").val(),cut:DOG.cut,reason:"reneg"==a?$("#reason").val():""};if(d.fio)if(REGEXP_NUMERIC.test(d.nomer)&&0!=d.nomer)if(REGEXP_CENA.test(d.sum)&&0!=d.sum)if(d.avans&&!REGEXP_CENA.test(d.avans))e("Некорректно указан авансовый платёж","avans",b);else{if("reneg"!=a||d.reason)return d;e("Не указана причина перезаключения договора","reason",b)}else e("Некорректно указана сумма по договору",
"sum",b);else e("Некорректно указан номер договора","nomer",b);else e("Не указано Фио клиента","fio",b);return!1}function c(){var a=q[m-1],a='<tr><td class="label">'+m+'-й платёж:<td><input type="text" class="cutsum" id="i'+m+'" maxlength="7" value="'+(a?a[0]:"")+'"> руб. <input type="hidden" id="d'+m+'" value="'+(a?a[1]:"")+'">';$("#cut-add").before(a);1!=m||q[0]||$("#i1").val($("#cut-itog").html());$("#i"+m).focus().keyup(d);$("#d"+m)._calendar();m++}function d(){var a=$(".cutsum"),b=0,d,c=[];for(h=
0;h<a.length;h++)if((d=$.trim(a.eq(h).val()))&&0!=d){if(!REGEXP_CENA.test(d)){b=!1;break}b+=1*d;c.push(1*d+":"+a.eq(h).next().find("input").val())}!1===b&&(b=Math.round(100*b)/100);$("#cut-itog").html(b);return!1===b?"error":c}function f(){var a=d();"error"==a?s.bottom.vkHint({msg:'<span class="red">Некорректно заполнено поле платежа</span>',top:-47,left:84,indent:50,show:1,remove:1}):(DOG.cut=a.join(),g(),s.close())}function g(){var a=DOG.cut?DOG.cut.split(",").length:0;$("#cut").html(a?"Указан"+
_end(a,["а","ы"])+" дат"+_end(a,["а","ы"])+" для "+a+_end(a,["-го","-х","-и"])+" платеж"+_end(a,["а","ей"])+'. <u>Изменить</u><div class="img_del'+_tooltip("Отменить разбивку",-61)+"</div>":p);a&&$("#cut .img_del").click(function(a){a.stopPropagation();DOG.cut="";$("#cut").html(p)})}function e(a,b,d){r.bottom.vkHint({msg:'<span class="red">'+a+"</span>",top:d?-86:-47,left:d?173:142,indent:50,show:1,remove:1});b&&$("#"+b).focus()}var h,k="Заключение",l="Заключить договор",p="Указать даты очередных платежей",
m,s,q;switch(a){default:a="create";case "create":break;case "edit":k="Изменение данных";l="Применить";break;case "reneg":k="Перезаключение",l="Перезаключить договор"}var r=_dialog({width:480,top:10,head:k+" договора",content:'<table class="zayav-dogovor"><tr><td class="label">Фио клиента:<td><input type="text" id="fio" value="'+DOG.fio+'" /><tr><td class="label">Адрес:<td><input type="text" id="adres" value="'+DOG.adres+'" /><tr><td class="label">Паспорт:<td>Серия:<input type="text" id="pasp_seria" maxlength="8" value="'+
DOG.pasp_seria+'" />Номер:<input type="text" id="pasp_nomer" maxlength="10" value="'+DOG.pasp_nomer+'" /><tr><td><td><span class="l">Прописка:</span><input type="text" id="pasp_adres" maxlength="100" value="'+DOG.pasp_adres+'" /><tr><td><td><span class="l">Кем выдан:</span><input type="text" id="pasp_ovd" maxlength="100" value="'+DOG.pasp_ovd+'" /><tr><td><td><span class="l">Когда выдан:</span><input type="text" id="pasp_data" maxlength="100" value="'+DOG.pasp_data+'" /><tr><td class="label">Номер договора:<td><input type="text" id="nomer" maxlength="6" value="'+
DOG.nomer+'" /><tr><td class="label">Дата заключения:<td><input type="hidden" id="data_create" value="'+(DOG.data_create?DOG.data_create:"")+'" /><tr><td class="label">Сумма по договору:<td><input type="text" id="sum" class="money" maxlength="11" value="'+(DOG.sum?DOG.sum:"")+'" /> руб.<tr><td class="label">Авансовый платёж:<td><input type="text" id="avans" class="money" maxlength="11" value="'+(DOG.avans?DOG.avans:"")+'" /> руб. <span class="prim">(не обязательно)</span>'+("reneg"==a?'<tr><td class="label">Причина перезаключения:<td><input type="text" id="reason" />':
"")+'<tr><td colspan="2"><a id="cut"></a><tr><td colspan="2"><a id="preview">Предварительный просмотр договора</a><form action="'+AJAX_MAIN+'" method="post" id="preview-form" target="_blank"></form></table>',butSubmit:l,submit:function(){var d=b();d&&(d.op="dogovor_"+a,r.process(),$.post(AJAX_MAIN,d,function(a){a.success?(r.close(),_msg("Договор заключен."),document.location.reload()):(r.abort(),e(a.text))},"json"))}});$("#data_create")._calendar({lost:1});$("#cut").click(function(){var a=REGEXP_CENA.test($("#sum").val())?
$("#sum").val():0,b=REGEXP_CENA.test($("#avans").val())?$("#avans").val():0,a=a-b;s=_dialog({head:"Разбивка платежа на части",content:'<table class="cut-money"><tr><td class="label">Исходная сумма:<td><u>'+a+'</u> руб.<tr id="cut-add"><td><td><a>Добавить поле</a><tr><td class="label">Итоговая сумма:<td><b id="cut-itog">'+a+"</b> руб.</table>",butSubmit:"Применить",submit:f});m=1;q=[];if(DOG.cut)for(a=DOG.cut.split(","),h=0;h<a.length;h++)b=a[h].split(":"),q.push([b[0],b[1]]),c();else c();d();$("#cut-add a").click(c)}).vkHint({width:180,
msg:"Разбить оставшуюся сумму платежа по заявке на части и создать по ним напоминания.",delayShow:400,top:-82,left:118});g();$("#preview").click(function(){var a=b("preview");if(a){a.op="dogovor_preview";var d="",c;for(c in a)d+='<input type="hidden" name="'+c+'" value="'+a[c]+'">';$("#preview-form").html(d).submit()}});$("#reason").autosize()},historyFilter=function(){return{op:"history_spisok",limit:$("#history_limit").val(),worker_id:$("#history_worker_id").val(),cat_id:$("#history_cat_id").val(),
client_id:$("#history_client_id").val(),zayav_id:$("#history_zayav_id").val()}},historySpisok=function(a,b){var c=historyFilter();c[b]=a;$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,c,function(a){$("#mainLinks").removeClass("busy");a.success&&$(".left").html(a.html)},"json")},incomeSpisok=function(){var a={op:"income_spisok",day:$(".selected").val(),income_id:$("#income_id").val(),worker_id:$("#worker_id").val()};$(".inc-path").addClass("_busy");$.post(AJAX_MAIN,a,function(a){$(".inc-path").removeClass("_busy");
a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},incomeChoiceSum=function(){var a,b=$("._money .choice"),c=0,d=0,f=!0,g=[];for(a=0;a<b.length;a++){var e=b.eq(a);1==e.find("input").val()?(c++,d+=1*e.parent().find(".sum").html().replace(" ",""),g.push(e.parent().attr("val"))):f=!1}$(".income_choice_sum").html(c?"Выбран"+_end(c,["","о"])+" <b>"+c+"</b> платеж"+_end(c,["","а","ей"])+" на сумму <b>"+d+"</b> руб.":"");$("#money_all")._check(f);return{count:c,ids:g.join(),sum:d}},
expenseFilter=function(){for(var a=[],b=$("#monthList input"),c=1;12>=c;c++)1==b.eq(c-1).val()&&a.push(c);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")},salaryCheck=function(){var a=
$("._check"),b,c,d="",f=0,g=0,e=[];for(b=0;b<a.length;b++)c=a.eq(b),0!=c.find("input").val()&&"salary_all_check"!=c.attr("id")&&(f++,c=c.parent().parent(),e.push(c.attr("val")),g+=1*c.find(".sum").html());f&&(d="Выбран"+_end(f,["а","о"])+" <b>"+f+"</b> запис"+_end(f,["ь","и","ей"])+" на сумму <b>"+g+'</b> руб.<a class="salary-list" val="'+e.join()+'">Распечатать лист выдачи з/п</a>');$("#salary-sel").html(d)},salarySpisok=function(){if(!$(".headName").hasClass("_busy")){MON=1*$("#salmon").val();YEAR=
$("#year").val();var a={op:"salary_spisok",worker_id:WORKER_ID,year:YEAR,mon:MON};$(".headName").addClass("_busy");$.post(AJAX_MAIN,a,function(a){$(".headName").removeClass("_busy");a.success&&($(".headName em").html(MONTH_DEF[MON]+" "+YEAR),$("#spisok").html(a.html),$("#monthList").html(a.month))},"json")}};
...
d)._select({width:119,title0:"Не указано",spisok:PRODUCT_SPISOK,func:function(a){$("#"+e)._select("remove").val(0);0<a&&PRODUCT_SUB_SPISOK[a]&&c(a,e,h);$("#"+h).val(0<a?1:"").focus()}});c(a[0]||0,e,h);g++}function c(a,b,d){0!=a&&PRODUCT_SUB_SPISOK[a]&&$("#"+b)._select({width:120,title0:"Подвид не указан",spisok:PRODUCT_SUB_SPISOK[a],func:function(){$("#"+d).focus()}})}var d=$(this),f=d.attr("id"),g=1,e;if("string"==typeof a&&"get"==a){a=d.find(".ptab");d=[];for(e=0;e<a.length;e++){var h=a.eq(e),k=
...
butSubmit:""})}).on("click",".zayav_unit",function(){document.location.href=URL+"&p=zayav&d=info&id="+$(this).attr("val")}).on("click","#zayav ._next",function(){var a=$(this);if(!a.hasClass("busy")){var b=zayavFilter();b.page=a.attr("val");a.addClass("busy");$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.spisok).remove():a.removeClass("busy")},"json")}}).on("click","#zayav .filter_clear",function(){$(".find-hide").removeClass("dn");$("#find")._search("clear");$("#product_id")._select(0);zayavSpisok()}).on("click",
".zakaz_add",function(){window.CLIENT||(CLIENT={id:0,fio:"",adres:""});var a=_dialog({width:550,top:30,head:"Внесение нового заказа",content:'<table class="zayav-add"><tr><td class="label">Клиент:<td><INPUT type="hidden" id="client_id" value="'+CLIENT.id+'"><b>'+CLIENT.fio+'</b><tr><td class="label topi">Изделие:<td id="product"><tr><td><td><input type="text" id="zakaz_txt" placeholder="либо укажите содержание заказа вручную.." maxlength="300"><tr><td class="label top">Заметка:\t<td><textarea id="comm"></textarea></table>',
...
c,function(d){d.success?(b.close(),_msg("Удалено."),a.remove()):b.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).on("click",".salary .ze_del",function(){for(var a=$(this),b=_dialog({top:110,width:250,head:"Удаление",content:"<CENTER>Подтвердите удаление записи.</CENTER>",butSubmit:"Удалить",submit:function(){var c={op:"salary_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(d){d.success?(b.close(),_msg("Удалено."),a.remove()):b.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).ready(function(){$("#pin-enter").length&&
...
($("#dopLinks .link").click(function(){$("#dopLinks .link").removeClass("sel");$(this).addClass("sel");var a=$(this).attr("val");$(".res").css("display","zayav"==a?"block":"none");$("#zayav_filter").css("display","zayav"==a?"block":"none");$("#zayav_spisok").css("display","zayav"==a?"block":"none");$("#income_spisok").css("display","money"==a?"block":"none");$(".remind_spisok").css("display","remind"==a?"block":"none");$("#comments").css("display","comm"==a?"block":"none");$("#histories").css("display",
"hist"==a?"block":"none")}),$(".cedit").click(function(){function a(){var d={op:"client_edit",client_id:CLIENT.id,fio:$("#fio").val(),telefon:$("#telefon").val(),adres:$("#adres").val(),pasp_seria:$("#pasp_seria").val(),pasp_nomer:$("#pasp_nomer").val(),pasp_adres:$("#pasp_adres").val(),pasp_ovd:$("#pasp_ovd").val(),pasp_data:$("#pasp_data").val()};d.fio?(b.process(),$.post(AJAX_MAIN,d,function(a){a.success?(CLIENT=a,$(".left:first").html(a.html),b.close(),_msg("Данные клиента изменены.")):b.abort()},
"json")):(b.bottom.vkHint({msg:'<span class="red">Не указано имя клиента.</span>',top:-47,left:100,indent:50,show:1,remove:1}),$("#fio").focus())}var b=_dialog({head:"Редактирование данных клиента",top:30,width:380,content:'<table class="client-add"><tr><td class="label">Имя:<td><input type="text" id="fio" maxlength="100" value="'+CLIENT.fio+'"><tr><td class="label">Телефон:<td><input type="text" id="telefon" maxlength="100" value="'+CLIENT.telefon+'"><tr><td class="label">Адрес:<td><input type="text" id="adres" maxlength="100" value="'+
CLIENT.adres+'"><tr><td><td><b>Паспортные данные:</b><tr><td class="label">Серия:<td><input type="text" id="pasp_seria" maxlength="8" value="'+CLIENT.pasp_seria+'"><span class="label">Номер:</span><input type="text" id="pasp_nomer" maxlength="10" value="'+CLIENT.pasp_nomer+'"><tr><td class="label">Прописка:<td><input type="text" id="pasp_adres" maxlength="100" value="'+CLIENT.pasp_adres+'"><tr><td class="label">Кем выдан:<td><input type="text" id="pasp_ovd" maxlength="100" value="'+CLIENT.pasp_ovd+
'"><tr><td class="label">Когда выдан:<td><input type="text" id="pasp_data" maxlength="100" value="'+CLIENT.pasp_data+'"></table>',butSubmit:"Сохранить",submit:a});$("#fio,#telefon,#adres,#pasp_seria,#pasp_nomer,#pasp_adres,#pasp_ovd,#pasp_data").keyEnter(a)}),$(".cdel").click(function(){var a=_dialog({top:90,width:300,head:"Удаление клиента",content:"<center>Внимание!<br />Будут удалены все данные о клиенте,<br />его заявки, платежи и задачи.<br /><b>Подтвердите удаление.</b></center>",butSubmit:"Удалить",
submit:function(){var b={op:"client_del",id:CLIENT.id};a.process();$.post(AJAX_MAIN,b,function(b){b.success?(a.close(),_msg("Клиент удален!"),location.href=URL+"&p=client"):a.abort()},"json")}})}));if($("#zayav").length){$("#find")._search({width:153,focus:1,txt:"Быстрый поиск...",enter:1,func:zayavFindFast}).vkHint({width:220,msg:"<b>Быстрый поиск</b> производится одновременно по всем категориям заявок. Учитываются поля: номер договора, номера ВГ, Ж, Д, адрес установки, Фио и телефоны клиентов и порядковый номер заявки. Другие условия фильтра игонрируются.",
...
func:historySpisok}),$("#cat_id")._select({width:160,title0:"Любая категория",spisok:HISTORY_GROUP,func:historySpisok}));$("#report.income").length&&(window._calendarFilter=incomeSpisok,$("#income_id")._select({width:160,title0:"Любые платежи",spisok:INCOME_SPISOK,func:incomeSpisok}),window.WORKERS&&$("#worker_id")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:incomeSpisok}));$("#report.expense").length&&($(".add").click(function(){function a(){var c={op:"expense_add",category:1*
$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val(),mon:$("#tabmon").val(),year:$("#tabyear").val()};c.category||c.about?c.invoice?REGEXP_CENA.test(c.sum)&&0!=c.sum?(e.process(),$.post(AJAX_MAIN,c,function(a){a.success?(e.close(),_msg("Новый расход внесён."),expenseSpisok()):e.abort()},"json")):(b("Некорректно указана сумма."),$("#sum").focus()):b("Укажите с какого счёта производится оплата."):(b("Выберите категорию или укажите описание."),
$("#about").focus())}function b(a){e.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var c='<table id="expense-add-tab"><tr><td class="label">Категория:<TD><INPUT type="hidden" id="cat"><a href="'+URL+'&p=setup&d=expense" class="img_edit'+_tooltip("Настройка категорий расходов",-95)+'</a><tr class="tr-work dn"><td class="label">Сотрудник:<TD><INPUT type="hidden" id="work"><tr class="tr-work dn"><td class="label">Месяц:<td><input type="hidden" id="tabmon" value="'+
((new Date).getMonth()+1)+'" /> <input type="hidden" id="tabyear" value="'+(new Date).getFullYear()+'" /><tr><td class="label">Описание:<TD><INPUT type="text" id="about" maxlength="100"><tr><td class="label">Со счёта:<TD><INPUT type="hidden" id="invoice"><a href="'+URL+'&p=setup&d=invoice" class="img_edit'+_tooltip("Настройка счетов",-56)+'</a><tr><td class="label">Сумма:<TD><INPUT type="text" id="sum" class="money" maxlength="11"> руб.</table>',e=_dialog({width:380,head:"Внесение расхода",content:c,
