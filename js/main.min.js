...
"salary_all_check"!=c.attr("id")&&(g++,c=c.parent().parent(),e.push(c.attr("val")),f+=1*c.find(".sum").html());g&&(d="Выбран"+_end(g,["","о"])+" <b>"+g+"</b> запис"+_end(g,["ь","и","ей"])+" на сумму <b>"+f+'</b> руб.<a class="salary-list" val="'+e.join()+'">Распечатать лист выдачи з/п</a>');$("#salary-sel").html(d)},salarySpisok=function(){MON=1*$("#salmon").val();YEAR=$("#year").val();var a={op:"salary_spisok",worker_id:WORKER_ID,year:$("#year").val(),mon:$("#salmon").val()};$.post(AJAX_MAIN,a,function(a){a.success&&
($(".headName em").html(MONTH_DEF[MON]+" "+YEAR),$("#spisok").html(a.html))},"json")};
