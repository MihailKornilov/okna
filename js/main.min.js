...
cat_id:$("#history_cat_id").val(),client_id:$("#history_client_id").val(),zayav_id:$("#history_zayav_id").val()}},historySpisok=function(a,b){var c=historyFilter();c[b]=a;$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,c,function(a){$("#mainLinks").removeClass("busy");a.success&&$(".left").html(a.html)},"json")},incomeSpisok=function(){var a={op:"income_spisok",day:$(".selected").val(),income_id:$("#income_id").val(),worker_id:$("#worker_id").val()};$(".inc-path").addClass("_busy");$.post(AJAX_MAIN,
a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},incomeChoiceSum=function(){var a,b=$("._money .choice"),c=0,d=0,f=!0,g=[];for(a=0;a<b.length;a++){var e=b.eq(a);1==e.find("input").val()?(c++,d+=1*e.parent().find(".sum").html().replace(" ",""),g.push(e.parent().attr("val"))):f=!1}$(".income_choice_sum").html(c?"Выбран"+_end(c,["","о"])+" <b>"+c+"</b> платеж"+_end(c,["","а","ей"])+" на сумму <b>"+d+"</b> руб.":"");$("#money_all")._check(f);
...
title0:"Любые платежи",spisok:INCOME_SPISOK,func:incomeSpisok}),window.WORKERS&&$("#worker_id")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:incomeSpisok}));$("#report.expense").length&&($(".add").click(function(){function a(){var c={op:"expense_add",category:1*$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val(),mon:$("#tabmon").val(),year:$("#tabyear").val()};c.category||c.about?c.invoice?REGEXP_CENA.test(c.sum)&&0!=
c.sum?(e.process(),$.post(AJAX_MAIN,c,function(a){a.success?(e.close(),_msg("Новый расход внесён."),expenseSpisok()):e.abort()},"json")):(b("Некорректно указана сумма."),$("#sum").focus()):b("Укажите с какого счёта производится оплата."):(b("Выберите категорию или укажите описание."),$("#about").focus())}function b(a){e.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var c='<table id="expense-add-tab"><tr><td class="label">Категория:<TD><INPUT type="hidden" id="cat"><a href="'+
