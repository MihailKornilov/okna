...
$.fn.productList=function(a){function b(a){var b=e+g,d=b+"id",f=b+"subid",k=b+"count";m.before('<table id="ptab'+g+'" class="ptab" val="'+g+'"><tr><td class="td"><input type="hidden" id="'+d+'" value="'+(a[0]||0)+'" /><input type="hidden" id="'+f+'" value="'+(a[1]||0)+'" /><td class="td"><input type="text" id="'+k+'" value="'+(a[2]||"")+'" class="count" maxlength="3" /> шт.'+(1<g?'<div class="img_del"></div>':"")+"</table>");var h=$("#ptab"+g);h.find(".img_del").click(function(){h.remove()});$("#"+
d)._select({width:119,title0:"Не указано",spisok:PRODUCT_SPISOK,func:function(a){$("#"+f)._select("remove").val(0);0<a&&PRODUCT_SUB_SPISOK[a]&&c(a,f,k);$("#"+k).val(0<a?1:"").focus()}});c(a[0]||0,f,k);g++}function c(a,b,c){0!=a&&PRODUCT_SUB_SPISOK[a]&&$("#"+b)._select({width:120,title0:"Подвид не указан",spisok:PRODUCT_SUB_SPISOK[a],func:function(){$("#"+c).focus()}})}var d=$(this),e=d.attr("id"),g=1,f;if("string"==typeof a&&"get"==a){a=d.find(".ptab");d=[];for(f=0;f<a.length;f++){var h=a.eq(f),k=
...
'"><input type="text" class="zrsum" maxlength="6"'+(a[3]?" disabled":"")+' tabindex="'+10*e+'" value="'+a[2]+'" />руб.<input type="hidden" id="'+(c+"list")+'" value="'+a[3]+'" /></table>');var k=$("#ptab"+e),h=k.find(".tddop"),m=k.find(".zrsum");$("#"+g)._select({width:120,disabled:a[3],title0:"Категория",spisok:ZAYAVEXPENSE_SPISOK,func:function(a){k.find(".tdsum")[(0<a?"remove":"add")+"Class"]("dn");ZAYAVEXPENSE_TXT[a]?(h.html('<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+
(10*e-11)+'" />'),h.find(".zrtxt").focus()):(ZAYAVEXPENSE_WORKER[a]?(h.html('<input type="hidden" id="'+f+'" />'),$("#"+f)._select({width:150,title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){m.focus()}})):h.html(""),m.focus());m.val("");0<a&&!k.next().hasClass("ptab")&&b()}});a[0]&&ZAYAVEXPENSE_WORKER[a[0]]&&$("#"+f)._select({width:150,disabled:a[3],title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){m.focus()}});e++}var c=$(this),d=c.attr("id"),e=1,g;if("string"==typeof a&&"get"==a){a=
...
if(g)for(n=0;n<e;n++){var d=h.eq(n).val();if(REGEXP_CENA.test(d))a.push(CASH[n].id+"="+1*d.replace(",","."));else{b("Некорректно указана сумма");h.eq(n).focus();return}}a={op:"invoice_set",invoice_id:c,sum:g?0:$("#sum").val(),cash:a.join(":")};g||REGEXP_CENA.test(a.sum)?(f.process(),$.post(AJAX_MAIN,a,function(a){a.success?($("#cash-spisok").html(a.c),$("#invoice-spisok").html(a.i),f.close(),_msg("Баланс установлен.")):f.abort()},"json")):(b("Некорректно указана сумма"),$("#sum").focus())}function b(a){f.bottom.vkHint({msg:'<SPAN class="red">'+
a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:72})}window.CASH||(window.CASH=[]);var c=$(this).attr("val"),d='<table class="_dialog-tab">',e=CASH.length,g="1"==c&&!!e;if(g){for(n=0;n<e;n++)d+='<tr><td class="label">'+CASH[n].name+':<td><INPUT type="text" class="money" maxlength="11" value="'+CASH[n].sum+'"> руб.';d+='<tr><td class="label">Счёт <b>'+INVOICE_NAME+'</b>:<td><b id="summa">0</b> руб.'}else d+='<tr><td class="label">Сумма:<td><INPUT type="text" class="money" id="sum" maxlength="11"> руб.';
var f=_dialog({width:320,head:"Установка текущей суммы счёта",content:d+"</table>",butSubmit:"Установить",submit:a}),h=f.content.find("input");h.eq(0).focus();h.keyEnter(a);g&&h.keyup(function(){var a=0;for(n=0;n<e;n++){var b=h.eq(n).val();if(REGEXP_CENA.test(b))a+=1*b.replace(",",".");else{a=0;break}}$("#summa").html(a)})}).on("click","#report.invoice .img_note",function(){function a(a,b){var c=$(".invoice-history #dopLinks"),f={op:"invoice_history_ostatok",invoice_id:$("#invoice_history_id").val(),
year:"ih-year"==b?a:$("#ih-year").val(),mon:"ih-mon"==b?a:$("#ih-mon").val()};c.hasClass("_busy")||(c.addClass("_busy"),$.post(AJAX_MAIN,f,function(a){c.removeClass("_busy");a.success&&$("#ih-spisok").html(a.html)},"json"))}var b=_dialog({top:20,width:570,head:"История операций со счётом",load:1,butSubmit:"",butCancel:"Закрыть"}),c={op:"invoice_history",invoice_id:$(this).attr("val")};$.post(AJAX_MAIN,c,function(c){c.success?(b.content.html('<div class="invoice-history">'+c.html+"</div>"),$("#ih-year")._select({width:50,
spisok:[{uid:2014,title:2014},{uid:2015,title:2015}],func:a}),$("#ih-mon")._select({width:80,spisok:MON_SPISOK,func:a})):b.loadError()},"json")}).on("click",".invoice-history .full,.invoice-history .ostatok",function(){var a=$(this),b=a.parent();if(!a.hasClass("sel")){b.find(".sel").removeClass("sel");a.addClass("sel");b.addClass("_busy");var c=a.hasClass("full")?"full":"ostatok",a={op:"invoice_history_"+c,invoice_id:$("#invoice_history_id").val(),year:$("#ih-year").val(),mon:$("#ih-mon").val()};
$.post(AJAX_MAIN,a,function(a){b.removeClass("_busy");a.success&&($("#ih-spisok").html(a.html),$("#ih-data")[("full"==c?"add":"remove")+"Class"]("dn"))},"json")}}).on("click",".invoice-history .to-day",function(){var a=$(".invoice-history #dopLinks");if(!a.hasClass("_busy")){a.find("a.sel").removeClass("sel");a.find("a.full").addClass("sel");a.addClass("_busy");var b=$(this),b={op:"invoice_history_full",invoice_id:$("#invoice_history_id").val(),day:b.attr("val")};$.post(AJAX_MAIN,b,function(b){a.removeClass("_busy");
b.success&&($("#ih-spisok").html(b.html),$("#ih-data").addClass("dn"))},"json")}}).on("click",".invoice-history .ih-clear",function(){var a=$(".invoice-history #dopLinks");if(!a.hasClass("_busy")){a.addClass("_busy");$(this);var b={op:"invoice_history_full",invoice_id:$("#invoice_history_id").val()};$.post(AJAX_MAIN,b,function(b){a.removeClass("_busy");b.success&&($("#ih-spisok").html(b.html),$("#ih-data").addClass("dn"))},"json")}}).on("click",".invoice-history ._next",function(){var a=$(this),b=
{op:"invoice_history",page:a.attr("val"),invoice_id:$("#invoice_history_id").val()};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click","#money_all_check",function(){for(var a=$(this),b=a.find("input").val();!a.hasClass("_money");)a=a.parent();for(var c=a.find("tr"),a=1;a<c.length;a++)c.eq(a).find("input:first")._check(b)}).on("click",".inc ._check",incomeChoiceSum).on("click",".transfer-show",function(){var a=
_dialog({top:20,width:480,head:"Просмотр подтверждённых переводов",load:1,butSubmit:"",butCancel:"Закрыть"}),b={op:"transfer_show",ids:$(this).attr("val")};$.post(AJAX_MAIN,b,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click",".transfer-spisok .img_del",function(){var a=$(this),b=_dialog({head:"Удаление перевода",content:"<center>Подтвердите удаление перевода.</center>",butSubmit:"Удалить",submit:function(){var c={op:"transfer_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,
c,function(a){a.success?($("#cash-spisok").html(a.c),$("#invoice-spisok").html(a.i),$(".transfer-spisok").html(a.t),b.close(),_msg("Перевод удалён.")):b.abort()},"json")}})}).on("click",".transfer-spisok ._next",function(){var a=$(this),b={op:"transfer_spisok",page:a.attr("val")};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".income-confirm",function(){var a=_dialog({top:20,width:480,head:"Подтверждение платежей",
load:1,butSubmit:"Подтвердить",submit:function(){var b={op:"income_confirm",ids:incomeChoiceSum().ids};b.ids?(a.process(),$.post(AJAX_MAIN,b,function(b){b.success?($("#confirm-info").html(b.confirm),$("#cash-spisok").html(b.c),$("#invoice-spisok").html(b.i),a.close(),_msg("Платежи подтверждены.")):a.abort()},"json")):a.bottom.vkHint({msg:'<SPAN class="red">Платежи не выбраны</SPAN>',remove:1,indent:50,show:1,top:-48,left:143})}});$.post(AJAX_MAIN,{op:"income_confirm_get"},function(b){b.success?a.content.html(b.html+
'<div class="income_choice_sum"></div>'):a.loadError()},"json")}).on("click",".transfer-confirm",function(){function a(){for(var a=b.content.find("._check"),d=[],e=0;e<a.length;e++){var g=a.eq(e).find("input");1==g.val()&&d.push(g.attr("id").split("_")[0])}d.length?(a={op:"transfer_confirm",ids:d.join(),about:$("#about").val()},b.process(),$.post(AJAX_MAIN,a,function(a){a.success?($("#invoice-spisok").html(a.i),$(".transfer-spisok").html(a.t),b.close(),_msg("Переводы подтверждены.")):b.abort()},"json")):
b.bottom.vkHint({msg:'<SPAN class="red">Платежи не выбраны</SPAN>',remove:1,indent:50,show:1,top:-48,left:163})}var b=_dialog({top:20,width:520,head:"Подтверждение переводов",load:1,butSubmit:"Подтвердить",submit:a});$.post(AJAX_MAIN,{op:"transfer_confirm_get"},function(c){c.success?(b.content.html(c.html+'<div class="transfer-about">Описание: <input type="text" id="about" /></div>'),$("#about").keyEnter(a)):b.loadError()},"json")}).on("click",".income-show",function(){var a=_dialog({top:20,width:480,
head:"Просмотр платежей",load:1,butSubmit:"",butCancel:"Закрыть"}),b={op:"income_transfer_show",ids:$(this).attr("val")};$.post(AJAX_MAIN,b,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,type:$("#income_opl").val(),confirm:$("#confirm").val(),sum:$("#sum").val(),zayav_id:$("#zayav_id").val()||0,client_id:OPL.client_id||0,prim:$.trim($("#prim").val())};0==a.type?b("Не указан вид платежа"):REGEXP_CENA.test(a.sum)&&
0!=a.sum?$("#zayav_id").length&&0==a.zayav_id&&!a.prim?(b("Если не выбрана заявка, необходимо указать комментарий"),$("#prim").focus()):$("#zayav_id").length||a.prim?(d.process(),$.post(AJAX_MAIN,a,function(a){if(a.success)switch(d.close(),_msg("Платёж успешно внесён!"),OPL.from){case "client":$("#income_spisok").html(a.html);$(".left:first").html(a.balans);break;case "zayav":zayavInfoMoneyUpdate();$("#income_spisok").html(a.html);break;case "income":incomeSpisok()}else d.abort()},"json")):(b("Необходимо указать комментарий"),
...
URL+'&p=setup&d=income" class="img_edit'+_tooltip("Настройка видов платежей",-85)+'</a><tr class="tr_confirm dn"><td class="label">Подтверждение:<td><input type="hidden" id="confirm"><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11"> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100"></table>',d=_dialog({width:440,head:"Внесение платежа",content:c,submit:a});$("#sum").focus();$("#sum,#prim").keyEnter(a);OPL.zayav_spisok&&$("#zayav_id")._select({width:210,
title0:"Не указана",spisok:OPL.zayav_spisok});$("#income_opl")._select({width:180,title0:"Не указан",spisok:INCOME_SPISOK,func:function(a){$("#sum").focus();$(".tr_confirm")[(INCOME_CONFIRM[a]?"remove":"add")+"Class"]("dn");$("#confirm")._check(0)}});$("#confirm")._check();$("#confirm_check").vkHint({width:210,msg:"Установите галочку, если платёж нужно внести, но требуется подтверждение о его поступлении на счёт.",top:-96,left:-100})}).on("click",".income-del",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=
a.parent();if(!a.hasClass("deleting")){a.addClass("deleting");var b={op:"income_del",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){a.removeClass("deleting");b.success&&(window.ZAYAV&&zayavInfoMoneyUpdate(),a.addClass("deleted"))},"json")}}).on("click",".income-rest",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();var b={op:"income_rest",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){b.success&&(window.ZAYAV&&zayavInfoMoneyUpdate(),a.removeClass("deleted"))},"json")}).on("click",
"#income_next",function(){var a=$(this),b={op:"income_next",page:$(this).attr("val"),limit:$("#money_limit").val(),client_id:$("#money_client_id").val(),zayav_id:$("#money_zayav_id").val(),deleted:$("#money_deleted").val(),income_id:$("#money_income_id").val(),owner_id:$("#money_owner_id").val(),worker_id:$("#money_worker_id").val(),day:$(".selected").val()||""};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",
".expense #monthList div",expenseSpisok).on("click",".expense ._next",function(){var a=$(this),b=expenseFilter();b.page=a.attr("val");a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".expense .img_del",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();if(!a.hasClass("deleting")){a.addClass("deleting");var b={op:"expense_del",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){a.removeClass("deleting");
b.success&&a.addClass("deleted")},"json")}}).on("click",".expense .img_rest",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();var b={op:"expense_rest",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){b.success&&a.removeClass("deleted")},"json")}).on("click",".expense .img_edit",function(){function a(a){c.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}for(var b=$(this);"TR"!=b[0].tagName;)b=b.parent();var c=_dialog({width:380,head:"Редактирование расхода",
load:1,butSubmit:"Сохранить",submit:function(){var b={id:d,op:"expense_edit",category:1*$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val()};b.category||b.about?b.invoice?REGEXP_NUMERIC.test(b.sum)?(c.process(),$.post(AJAX_MAIN,b,function(a){a.success?(c.close(),_msg("Расход изменён."),expenseSpisok()):c.abort()},"json")):(a("Некорректно указана сумма."),$("#sum").focus()):a("Укажите с какого счёта производится оплата."):(a("Выберите категорию или укажите описание."),
$("#about").focus())}}),d=b.attr("val");$.post(AJAX_MAIN,{op:"expense_get",id:d},function(a){c.content.html('<table id="expense-add-tab"><tr><td class="label">Категория:<td><input type="hidden" id="cat" value="'+a.category+'"><tr class="tr-work '+(EXPENSE_WORKER[a.category]?"":"dn")+'"><td class="label">Сотрудник:<td><input type="hidden" id="work" value="'+a.worker+'"><tr><td class="label">Описание:<td><input type="text" id="about" maxlength="150" value="'+a.about+'"><tr><td class="label">Со счёта:<td><input type="hidden" id="invoice" value="'+
...
left:161,indent:40,show:1,remove:1})}});$("#product").productList(ZAYAV.product)}),$(".set_edit").click(function(){function a(){var c,d={op:"set_edit",zayav_id:ZAYAV.id,product:$("#product").productList("get"),adres:$("#adres").val(),nomer_vg:$("#nomer_vg").val(),nomer_g:$("#nomer_g").val(),nomer_d:$("#nomer_d").val(),nomer_t:$("#nomer_t").val()};d.product?"count_error"==d.product?c="Некорректно введено количество изделий":d.adres?(b.process(),$.post(AJAX_MAIN,d,function(a){a.success?(b.close(),_msg("Данные изменены!"),
...
_tooltip("Настройка счетов",-56)+'</a><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11" /> руб.<span id="isum"></span><tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100" /></table>',d=_dialog({width:370,head:"Возврат",content:c,submit:a});$("#sum").focus();$("#sum,#prim").keyEnter(a);$("#invoice_id")._select({title0:"Не выбран",spisok:INVOICE_SPISOK,func:function(a){$("#sum").focus();$("#isum").html(ZAYAV.isum[a]?"max: <b>"+ZAYAV.isum[a]+
"</b>":"")}})}));$("#report.history").length&&($("#viewer_id_add")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:_history}),$("#action")._select({width:160,title0:"Любая категория",spisok:HISTORY_GROUP,func:_history}));$("#report.income").length&&(window._calendarFilter=incomeSpisok,$("#income_id")._select({width:160,title0:"Любые платежи",spisok:INCOME_SPISOK,func:incomeSpisok}),window.WORKERS&&$("#worker_id")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:incomeSpisok}),
$("#deleted")._check(incomeSpisok));$("#report.expense").length&&($(".add").click(function(){function a(){var c={op:"expense_add",category:1*$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:_cena($("#sum").val()),mon:$("#tabmon").val(),year:$("#tabyear").val()};c.category||c.about?c.invoice?c.sum?ISUM[c.invoice]&&c.sum>ISUM[c.invoice]?(b("Сумма превышает максимально допустимую"),$("#sum").focus()):(d.process(),$.post(AJAX_MAIN,c,function(a){a.success?
(d.close(),_msg("Новый расход внесён."),expenseSpisok()):d.abort()},"json")):(b("Некорректно указана сумма."),$("#sum").focus()):b("Укажите с какого счёта производится оплата."):(b("Выберите категорию или укажите описание."),$("#about").focus())}function b(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var c='<table id="expense-add-tab"><tr><td class="label">Категория:<td><input type="hidden" id="cat"><a href="'+URL+'&p=setup&d=expense" class="img_edit'+
...
center:function(){var a=$("#monthList input"),c=0;for(b=1;12>=b;b++)if(0==a.eq(b-1).val()){c=1;break}for(b=1;12>=b;b++)$("#c"+b)._check(c);expenseSpisok()}}));$("#report.invoice").length&&$(".transfer").click(function(){function a(){var b={op:"invoice_transfer",from:1*$("#from").val(),to:1*$("#to").val(),sum:_cena($("#sum").val()),ids:$("#ids").val()};b.from?b.to?b.from==b.to?c("Выберите другой счёт"):b.sum?CASH_SUM[b.from]&&0>d-b.sum?(c("Введённая сумма больше, чем на счёте-отправителе"),$("#sum").focus()):
(h.process(),$.post(AJAX_MAIN,b,function(a){a.success?($("#cash-spisok").html(a.c),$("#invoice-spisok").html(a.i),$(".transfer-spisok").html(a.t),h.close(),_msg("Перевод произведён.")):h.abort()},"json")):(c("Некорректно введена сумма"),$("#sum").focus()):c("Выберите счёт-получатель"):c("Выберите счёт-отправитель")}function c(a,b){h.bottom.vkHint({msg:'<span class="red">'+a+"</span>",top:b?-95:-47,left:b?197:92,indent:50,show:1,remove:1})}$(this);var d=0,h=_dialog({width:380,head:"Перевод между счетами",
content:'<table class="invoice-transfer"><tr><td class="label">Со счёта:<td><input type="hidden" id="from" /><span id="sum-from"></span><tr><td class="label">На счёт:<td><input type="hidden" id="to" /><span id="sum-to"></span><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" /> руб. <a class="income-choice">Выбрать платежи</a><input type="hidden" id="ids" /></table>',butSubmit:"Применить",submit:a});if(window.CASH_SPISOK&&!window.CSMOVE){for(b=0;b<INVOICE_SPISOK.length;b++)1!=
INVOICE_SPISOK[b].uid&&CASH_SPISOK.push(INVOICE_SPISOK[b]);INVOICE_SPISOK=CASH_SPISOK;window.CSMOVE=1}$("#from")._select({width:200,title0:"Не выбран",spisok:INVOICE_SPISOK,func:function(a){$(".income-choice").html("Выбрать платежи");$("#ids").val("");$("#sum").val("").attr("readonly",SELMONEY[a]?!0:!1);$("#sum-from").html(CASH_SUM[a]?"max: "+CASH_SUM[a]:"");d=CASH_SUM[a]?CASH_SUM[a]:0}});$("#to")._select({width:200,title0:"Не выбран",spisok:INVOICE_SPISOK,func:function(a){$("#sum-to").html(CASH_SUM[a]?
CASH_SUM[a]:"")}});$("#sum").keyEnter(a);$("#sum").keyup(function(){$("#ids").val()&&($(".income-choice").html("Выбрать платежи"),$("#ids").val(""),$("#sum").val(""))});$(".income-choice").click(function(){function a(){var c=incomeChoiceSum();$("#ids").val(c.ids);$(".income-choice").html(c.count+" платеж"+_end(c.count,["","а","ей"]));$("#sum").val(c.sum);b.close()}if(0==$("#from").val())c("Не выбран счёт-отправитель",1);else{var b=_dialog({top:20,width:480,head:"Выбор платежей для перевода",load:1,
butSubmit:"Готово",submit:a}),d={op:"income_choice",owner_id:$("#from").val(),ids:$("#ids").val()};$.post(AJAX_MAIN,d,function(a){a.success?(b.content.html(a.html+'<div class="income_choice_sum"></div>'),incomeChoiceSum()):b.loadError()},"json")}})});if($("#report.salary").length)if($("#uall").length){$("#uall")._check(function(a){var c=$("._check");for(b=1;b<c.length;b++)c.eq(b).find("input")._check(a)});var a=[],d;for(d in MONTH_DEF)a.push({uid:d,title:MONTH_DEF[d]});$("#rmon")._select({width:100,
spisok:a});$("#ryear")._select({width:60,spisok:YEARS});$(".vkButton").click(function(){var a=$(this),c=$("._check"),d=[];for(b=1;b<c.length;b++){var h=c.eq(b).find("input");1==h.val()&&d.push(h.attr("id").split("u")[1])}(c=d.join())?document.location.href=APP_HTML+"/view/salary_report.php?"+VALUES+"&ids="+c+"&mon="+$("#rmon").val()+"&year="+$("#ryear").val():a.vkHint({msg:'<span class="red">Не выбраны сотрудники</span>',top:-57,left:7,indent:50,show:1,remove:1})})}else $("#year").years({func:salarySpisok}),
