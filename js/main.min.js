...
d).vkSel({width:119,display:"inline-block",title0:"Не указано",spisok:PRODUCT_SPISOK,func:function(a){$("#vkSel_"+f).remove();$("#"+f).val(0);0<a&&PRODUCT_SUB_SPISOK[a]&&c(a,f,h);$("#"+h).val(0<a?1:"").focus()}});c(a[0]||0,f,h);g++}function c(a,b,c){0!=a&&PRODUCT_SUB_SPISOK[a]&&$("#"+b).vkSel({width:120,display:"inline-block",title0:"Подвид не указан",spisok:PRODUCT_SUB_SPISOK[a],func:function(){$("#"+c).focus()}})}var d=$(this),e=d.attr("id"),g=1,f;if("string"==typeof a&&"get"==a){a=d.find(".ptab");
d=[];for(f=0;f<a.length;f++){var k=a.eq(f),h=e+k.attr("val"),k=$("#"+h+"id").val(),m=$("#"+h+"subid").val(),h=$("#"+h+"count").val();if(0!=k){if(!REGEXP_NUMERIC.test(h)||0==h)return"count_error";d.push(k+":"+m+":"+h)}}return 0==d.length?!1:d.join()}d.html('<div class="_product-list"><a class="add">Добавить поле</a></div>');var l=d.find(".add");l.click(b);if("object"==typeof a)for(f=0;f<a.length;f++)b(a[f]);else b([]);return d};
$.fn.zayavRashod=function(a){function b(a){var c=d+e,g=c+"cat",f=c+"worker";n.append('<table id="ptab'+e+'" class="ptab" val="'+e+'"><tr><td><input type="hidden" id="'+g+'" value="'+(a[0]||0)+'" /><td class="tddop">'+(a[0]&&ZAYAVRASHOD_TXT_ASS[a[0]]?'<input type="text" class="zrtxt" tabindex="'+(10*e-1)+'" value="'+a[1]+'" />':"")+(a[0]&&ZAYAVRASHOD_WORKER_ASS[a[0]]?'<input type="hidden" id="'+f+'" value="'+a[1]+'" />':"")+'<td class="tdsum'+(a[0]?"":" dn")+'"><input type="text" class="zrsum" maxlength="6" tabindex="'+
10*e+'" value="'+(a[2]||"")+'" />руб.</table>');var h=$("#ptab"+e),k=h.find(".tddop"),l=h.find(".zrsum");a[0]&&ZAYAVRASHOD_WORKER_ASS[a[0]]&&$("#"+f).vkSel({width:150,display:"inline-block",title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(){l.focus()}});$("#"+g).vkSel({width:120,display:"inline-block",title0:"Категория",spisok:ZAYAVRASHOD_SPISOK,func:function(a){h.find(".tdsum")[(a?"remove":"add")+"Class"]("dn");ZAYAVRASHOD_TXT_ASS[a]?(k.html('<input type="text" class="zrtxt" tabindex="'+(10*
e-11)+'" />'),k.find(".zrtxt").focus()):(ZAYAVRASHOD_WORKER_ASS[a]?(k.html('<input type="hidden" id="'+f+'" />'),$("#"+f).vkSel({width:150,display:"inline-block",title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(){l.focus()}})):k.html(""),l.focus());l.val("");a&&!h.next().hasClass("ptab")&&b([])}});e++}var c=$(this),d=c.attr("id"),e=1,g;if("string"==typeof a&&"get"==a){a=c.find(".ptab");c=[];for(g=0;g<a.length;g++){var f=a.eq(g),k=d+f.attr("val"),h=$("#"+k+"cat").val();$("#"+k+"worker").val();
var m=f.find(".zrsum").val(),l="";if(0!=h){if(!REGEXP_NUMERIC.test(m)||0==m)return"sum_error";ZAYAVRASHOD_TXT_ASS[h]?l=f.find(".zrtxt").val():ZAYAVRASHOD_WORKER_ASS[h]&&(l=$("#"+k+"worker").val());c.push(h+":"+l+":"+m)}}return c.join()}c.html('<div class="_zayav-rashod"></div>');var n=c.find("._zayav-rashod");if("object"==typeof a)for(g=0;g<a.length;g++)b(a[g]);b([]);return c};
...
{id:0,fio:"",adres:""});var b=CLIENT.adres,c=_dialog({width:550,top:30,head:"Внесение новой заявки на замер",content:'<table class="zayav-add"><tr><td class="label">Клиент:<td><INPUT type="hidden" id="client_id" value="'+CLIENT.id+'"><b>'+CLIENT.fio+'</b><tr><td class="label top">Изделие:<td id="product"><tr><td class="label">Адрес проведения замера:<td><INPUT type="text" id="adres" maxlength="100" /><INPUT type="hidden" id="homeadres" /><tr><td class="label">Дата и время замера:<td class="zayav-zamer-dtime"><tr><td class="label">Длительность замера:<td><INPUT TYPE="hidden" id="zamer_duration" value="30" /><tr><td class="label top">Заметка:\t<td><textarea id="comm"></textarea></table>',
...
CLIENT.id+'"><b>'+CLIENT.fio+'</b><tr><td class="label top">Изделие:<td id="product"><tr><td class="label">Адрес установки:<td><INPUT type="text" id="adres" maxlength="100" /><INPUT type="hidden" id="homeadres" /><tr><td class="label top">Заметка:\t<td><textarea id="comm"></textarea></table>',submit:function(){var a,c={op:"set_add",client_id:$("#client_id").val(),product:$("#product").productList("get"),adres:$("#adres").val(),comm:$("#comm").val()};0==c.client_id?a="Не выбран клиент":c.product?"count_error"==
c.product?a="Некорректно введено количество изделий":c.adres?(b.process(),$.post(AJAX_MAIN,c,function(a){a.success?(b.close(),_msg("Заявка внесена"),location.href=URL+"&p=zayav&d=info&id="+a.id):b.abort()},"json")):a="Не указан адрес":a="Не указано изделие";a&&b.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",top:-48,left:171,indent:50,show:1,remove:1})}});if(0==CLIENT.id)var c=$("#client_id").clientSel({add:1,func:function(b){a=c.item(b).adres;1==$("#homeadres").val()&&$("#adres").val(a)}}).o;
$("#product").productList();$("#homeadres")._check({func:function(){$("#adres").val(a)}});$("#homeadres_check").vkHint({msg:"Совпадает с адресом проживания",top:-74,left:196,indent:60,delayShow:700});$("#comm").autosize()}).on("click",".set_status",function(){$(this);var a=_dialog({width:400,top:30,head:"Изменение статуса установки",content:'<table class="zamer-status-edit"><tr><td class="label topi">Статус установки:<td><INPUT type="hidden" id="edit_set" value="'+ZAYAV.status+'"></table>',butSubmit:"Применить",
...
$(".goyear span").html(a.html());$("#remind").removeClass("y")}).on("click","#history_next",function(){if(!$(this).hasClass("busy")){var a=$(this),b={op:"history_next",page:$(this).attr("val")};a.addClass("busy");$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).on("click","#money_next",function(){if(!$(this).hasClass("busy")){var a=$(this),b={op:"money_next",page:$(this).attr("val"),limit:$("#money_limit").val(),client_id:$("#money_client_id").val(),
zayav_id:$("#money_zayav_id").val()};a.addClass("busy");$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).on("click","#setup_worker .add",function(){function a(){if(!e.hasClass("busy")){d=0;$(".res").remove();var a={user_ids:$.trim($("#viewer_id").val()),fields:"photo_50",v:5.2};a.user_ids&&(e.addClass("busy"),VK.api("users.get",a,function(a){e.removeClass("busy");a.response&&(a=a.response[0],e.after('<table class="res"><tr><td class="photo"><img src='+
a.photo_50+'><td class="name">'+a.first_name+" "+a.last_name+"</table>"),d=a.id)}))}}function b(a,b){c.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:b,left:112})}var c=_dialog({top:50,width:400,head:"Добавление нового сотрудника",content:'<div id="setup_worker_add"><h1>Укажите адрес страницы пользователя или его ID ВКонтакте:</h1><input type="text" id="viewer_id" /><div class="vkButton"><button>Найти</button></div><a class="manual">Или заполните данные вручную..</a><table class="manual_tab"><tr><td class="label">Имя:<td><input type="text" id="first_name" /><tr><td class="label">Фамилия:<td><input type="text" id="last_name" /><tr><td class="label">Пол:<td><input type="hidden" id="sex" value="0" /><tr><td class="label">Должность:<td><input type="text" id="post" /></table></div>',
butSubmit:"Добавить",submit:function(){var a={op:"setup_worker_add",viewer_id:d,first_name:$("#first_name").val(),last_name:$("#last_name").val(),sex:$("#sex").val(),post:$("#post").val()};a.id||a.first_name||a.last_name?a.first_name&&a.last_name&&0==a.sex?b("Не указан пол",-47):(c.process(),$.post(AJAX_MAIN,a,function(a){a.success?(c.close(),_msg("Новый сотрудник успешно добавлен."),$("#spisok").html(a.html)):(c.abort(),b(a.text,-60))},"json")):b("Произведите поиск пользователя<br>или укажите вручную имя и фамилию",
-60)}}),d=0,e=$("#viewer_id").focus().keyEnter(a).next();e.click(a);$(".manual").click(function(){$(this).hide().next().show();$("#first_name").focus()});$("#sex")._radio({spisok:[{uid:2,title:"М"},{uid:1,title:"Ж"}]})}).on("click","#setup_worker .img_del",function(){for(var a=$(this);!a.hasClass("unit");)a=a.parent();var b=_dialog({top:110,width:250,head:"Удаление сотрудника",content:"<center>Подтвердите удаление сотрудника.</center>",butSubmit:"Удалить",submit:function(){var c={op:"setup_worker_del",
viewer_id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(a){a.success?(b.close(),_msg("Сотрудник удален."),$("#spisok").html(a.html)):b.abort()},"json")}})}).on("click","#setup_product .add",function(){function a(){var a={op:"setup_product_add",name:$("#name").val()};a.name?(b.process(),$.post(AJAX_MAIN,a,function(a){a.success?($(".spisok").html(a.html),b.close(),_msg("Внесено!")):b.abort()},"json")):(b.bottom.vkHint({msg:"<SPAN class=red>Не указано наименование</SPAN>",top:-47,left:99,indent:50,
show:1,remove:1}),$("#name").focus())}$(this);var b=_dialog({top:60,width:390,head:"Добавление нового наименования изделия",content:'<table style="border-spacing:10px"><tr><td class="label r">Наименование:<td><input id="name" type="text" maxlength="100" style="width:250px" /></table>',submit:a});$("#name").focus().keyEnter(a)}).on("click","#setup_product .img_edit",function(){function a(){var a={op:"setup_product_edit",id:c,name:$("#name").val()};a.name?(e.process(),$.post(AJAX_MAIN,a,function(a){a.success?
($(".spisok").html(a.html),e.close(),_msg("Сохранено!")):e.abort()},"json")):(e.bottom.vkHint({msg:"<SPAN class=red>Не указано наименование</SPAN>",top:-47,left:99,indent:50,show:1,remove:1}),$("#name").focus())}for(var b=$(this);"TR"!=b[0].tagName;)b=b.parent();var c=b.attr("val"),d=b.find(".name a");b.find(".dog").html();var b='<table style="border-spacing:10px"><tr><td class="label">Наименование:<td><input id="name" type="text" maxlength="100" style="width:250px" value="'+d.html()+'" /></table>',
e=_dialog({top:60,width:390,head:"Редактирование наименования изделия",content:b,butSubmit:"Сохранить",submit:a});$("#name").focus().keyEnter(a)}).on("click","#setup_product .img_del",function(){var a=$(this),b=_dialog({top:90,width:300,head:"Удаление изделия",content:"<center><b>Подтвердите удаление изделия.</b></center>",butSubmit:"Удалить",submit:function(){for(;"TR"!=a[0].tagName;)a=a.parent();var c={op:"setup_product_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(c){c.success?
(a.remove(),b.close(),_msg("Удалено!")):b.abort()},"json")}})}).on("click","#setup_product_sub .add",function(){function a(){var a={op:"setup_product_sub_add",product_id:PRODUCT_ID,name:$("#name").val()};a.name?(b.process(),$.post(AJAX_MAIN,a,function(a){a.success?($(".spisok").html(a.html),b.close(),_msg("Внесено!")):b.abort()},"json")):(b.bottom.vkHint({msg:"<SPAN class=red>Не указано наименование</SPAN>",top:-47,left:99,indent:50,show:1,remove:1}),$("#name").focus())}$(this);var b=_dialog({top:60,
width:390,head:"Добавление нового подвида изделия",content:'<table style="border-spacing:10px"><tr><td class="label">Наименование:<td><input id="name" type="text" maxlength="100" style="width:250px" /></table>',submit:a});$("#name").focus().keyEnter(a)}).on("click","#setup_product_sub .img_edit",function(){function a(){var a={op:"setup_product_sub_edit",id:b.attr("val"),name:$("#name").val()};a.name?(e.process(),$.post(AJAX_MAIN,a,function(b){b.success?(c.html(a.name),e.close(),_msg("Сохранено!")):
e.abort()},"json")):(e.bottom.vkHint({msg:"<SPAN class=red>Не указано наименование</SPAN>",top:-47,left:99,indent:50,show:1,remove:1}),$("#name").focus())}for(var b=$(this);"TR"!=b[0].tagName;)b=b.parent();var c=b.find(".name"),d='<table style="border-spacing:10px"><tr><td class="label">Наименование:<td><input id="name" type="text" maxlength="100" style="width:250px" value="'+c.html()+'" /></table>',e=_dialog({top:60,width:390,head:"Редактирование подвида изделия",content:d,butSubmit:"Сохранить",
