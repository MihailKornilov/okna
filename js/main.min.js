...
$(".inc-path").addClass("_busy");$.post(AJAX_MAIN,a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},incomeChoiceSum=function(){var a,b=$("._money .choice"),c=0,d=0,e=!0,f=[];for(a=0;a<b.length;a++){var h=b.eq(a);1==h.find("input").val()?(c++,d+=1*h.parent().find(".sum").html().replace(" ",""),f.push(h.parent().attr("val"))):e=!1}$(".income_choice_sum").html(c?"Выбран"+_end(c,["","о"])+" <b>"+c+"</b> платеж"+_end(c,["","а",
"ей"])+" на сумму <b>"+d+"</b> руб.":"");$("#money_all")._check(e);return{count:c,ids:f.join(),sum:d}},expenseFilter=function(){for(var a=[],b=$("#monthList input"),c=1;12>=c;c++)1==b.eq(c-1).val()&&a.push(c);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");
a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")},salaryCheck=function(){var a=$("._check"),b,c,d="&nbsp;",e=0,f=0,h=[];for(b=0;b<a.length;b++)c=a.eq(b),"salary_all_check"!=c.attr("id")&&0!=c.find("input").val()&&(e++,c=c.parent().parent(),h.push(c.attr("val")),f+=1*c.find(".sum").html());e&&(d="Выбран"+_end(e,["а","о"])+" <b>"+e+"</b> запис"+_end(e,["ь","и","ей"])+' на сумму <b id="salary-sum">'+f+'</b> руб.<a class="salary-list-create" val="'+h.join()+'">Создать лист выдачи з/п</a>');
...
$.fn.productList=function(a){function b(a){var b=e+f,d=b+"id",h=b+"subid",g=b+"count";m.before('<table id="ptab'+f+'" class="ptab" val="'+f+'"><tr><td class="td"><input type="hidden" id="'+d+'" value="'+(a[0]||0)+'" /><input type="hidden" id="'+h+'" value="'+(a[1]||0)+'" /><td class="td"><input type="text" id="'+g+'" value="'+(a[2]||"")+'" class="count" maxlength="3" /> шт.'+(1<f?'<div class="img_del"></div>':"")+"</table>");var k=$("#ptab"+f);k.find(".img_del").click(function(){k.remove()});$("#"+
d)._select({width:119,title0:"Не указано",spisok:PRODUCT_SPISOK,func:function(a){$("#"+h)._select("remove").val(0);0<a&&PRODUCT_SUB_SPISOK[a]&&c(a,h,g);$("#"+g).val(0<a?1:"").focus()}});c(a[0]||0,h,g);f++}function c(a,b,c){0!=a&&PRODUCT_SUB_SPISOK[a]&&$("#"+b)._select({width:120,title0:"Подвид не указан",spisok:PRODUCT_SUB_SPISOK[a],func:function(){$("#"+c).focus()}})}var d=$(this),e=d.attr("id"),f=1,h;if("string"==typeof a&&"get"==a){a=d.find(".ptab");d=[];for(h=0;h<a.length;h++){var g=a.eq(h),k=
e+g.attr("val"),g=$("#"+k+"id").val(),q=$("#"+k+"subid").val(),k=$("#"+k+"count").val();if(0!=g){if(!REGEXP_NUMERIC.test(k)||0==k)return"count_error";d.push(g+":"+q+":"+k)}}return 0==d.length?!1:d.join()}d.html('<div class="_product-list"><a class="add">Добавить поле</a></div>');var m=d.find(".add");m.click(b);if("object"==typeof a)for(h=0;h<a.length;h++)b(a[h]);else b([]);return d};
$.fn.zayavExpense=function(a){function b(a){a||(a=[0,"","",0,0,0,0]);var c=d+e,f=c+"cat",h=c+"worker",g=c+"acc",k=c+"mon",q=c+"year",c=c+"list",c='<table id="ptab'+e+'" class="ptab" val="'+e+'"><tr><td><input type="hidden" id="'+f+'" value="'+a[0]+'" /><td class="tddop">'+(a[0]&&ZAYAVEXPENSE_TXT[a[0]]?'<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*e-1)+'" value="'+a[1]+'" />':"")+(a[0]&&ZAYAVEXPENSE_WORKER[a[0]]?'<input type="hidden" id="'+h+'" value="'+a[1]+'" />':
"")+'<td class="tdsum'+(a[0]?"":" dn")+'"><input type="text" class="zrsum" maxlength="6"'+(a[6]?" disabled":"")+' tabindex="'+10*e+'" value="'+a[2]+'" />руб.<td class="tdacc'+(a[0]&&ZAYAVEXPENSE_WORKER[a[0]]&&a[1]?"":" dn")+'"><input type="hidden" id="'+g+'" value="'+a[3]+'" /><td class="tdmon'+(a[3]?"":" dn")+'"><input type="hidden" id="'+k+'" value="'+(a[4]||(new Date).getMonth()+1)+'" /><input type="hidden" id="'+q+'" value="'+(a[5]||(new Date).getFullYear())+'" /><input type="hidden" id="'+c+
'" value="'+a[6]+'" /></table>';s.append(c);var m=$("#ptab"+e),l=m.find(".tddop"),p=m.find(".zrsum"),r=m.find(".tdacc"),t=m.find(".tdmon");$("#"+f)._select({width:120,disabled:a[6],title0:"Категория",spisok:ZAYAVEXPENSE_SPISOK,func:function(a){m.find(".tdsum")[(0<a?"remove":"add")+"Class"]("dn");ZAYAVEXPENSE_TXT[a]?(l.html('<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*e-11)+'" />'),l.find(".zrtxt").focus()):(ZAYAVEXPENSE_WORKER[a]?(l.html('<input type="hidden" id="'+
h+'" />'),$("#"+h)._select({width:150,title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){p.focus();r[(a?"remove":"add")+"Class"]("dn");$("#"+g)._check(0);t.addClass("dn")}})):l.html(""),p.focus());p.val("");0<a&&!m.next().hasClass("ptab")&&b();r.addClass("dn");$("#"+g)._check(0);t.addClass("dn")}});a[0]&&ZAYAVEXPENSE_WORKER[a[0]]&&$("#"+h)._select({width:150,disabled:a[6],title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){p.focus();r[(a?"remove":"add")+"Class"]("dn");$("#"+g)._check(0);
t.addClass("dn")}});$("#"+g)._check({disabled:a[6],func:function(a){t[(a?"remove":"add")+"Class"]("dn")}});a[6]||$("#"+g+"_check").vkHint({msg:"Начислить",top:-58,left:-28,delayShow:1E3});$("#"+k)._dropdown({disabled:a[6],spisok:u});$("#"+q)._dropdown({disabled:a[6],spisok:[{uid:2014,title:2014}]});e++}var c=$(this),d=c.attr("id"),e=1,f;if("string"==typeof a&&"get"==a){a=c.find(".ptab");c=[];for(f=0;f<a.length;f++){var h=a.eq(f),g=d+h.attr("val"),k=$("#"+g+"cat").val(),q=h.find(".zrsum").val(),m=
"",l=0,r=0,p=0;if(0!=k){if(!REGEXP_NUMERIC.test(q)||0==q)return"sum_error";ZAYAVEXPENSE_TXT[k]?m=h.find(".zrtxt").val():ZAYAVEXPENSE_WORKER[k]&&(m=$("#"+g+"worker").val(),l=$("#"+g+"acc").val(),1==l&&(r=$("#"+g+"mon").val(),p=$("#"+g+"year").val()));c.push(k+":"+m+":"+q+":"+l+":"+r+":"+p+":"+$("#"+g+"list").val())}}return c.join()}c.html('<div class="_zayav-rashod"></div>');var s=c.find("._zayav-rashod"),u=[];for(f in MONTH_DEF)u.push({uid:f,title:MONTH_DEF[f]});if("object"==typeof a)for(f=0;f<a.length;f++)b(a[f]);
b();return c};
...
_dialog({width:250,head:"Подтверждение пин-кода",content:'<table class="setup-tab"><tr><td colspan="2"><div class="_info">Истекло время действия пин-кода. Требуется подтверждение.</div><tr><td class="label">Пин-код:<td><input id="tpin" type="password" maxlength="10" /></table>',butSubmit:"Подтвердить",butCancel:"",submit:d});$("#tpin").focus().keyEnter(d)}}).on("change","._attach input",function(){setCookie("_attached",0);for(var a=$(this);!a.hasClass("_attach");)a=a.parent();var b=a.find("form"),
c=a.find(".form"),d=setInterval(function(){var e=getCookie("_attached");0<e&&(clearInterval(d),1==e?(e={op:"attach_get",type:b.find(".type").val(),zayav_id:b.find(".zayav_id").val()},$.post(AJAX_MAIN,e,function(e){c.removeClass("_busy");e.success&&(a.find(".files").html(e.files),b.html(e.form))},"json")):(c.removeClass("_busy"),c.next(".red").remove(),c.after('<div class="red">Некорректный файл.</div>'),c.next(".red").fadeOut(4E3)))},500);c.addClass("_busy");b.submit()}).on("click","._attach .img_minidel",
...
a.after(b.spisok).remove():a.removeClass("busy")},"json"))}).on("click",".zayav_add",function(){_dialog({width:370,top:30,head:"Выберите категорию заявки",content:'<div class="zayav-add"><div class="item zakaz_add"><b>Заказ</b>Новый заказ для продажи изделий без установки.<br />При необходимости в будущем заказ можно будет перевести в Установку.</div><div class="item zamer_add"><b>Замер</b>Новая заявка на замер. Указывается дата и время замера. Заявка автоматически попадает в напоминания. Успешный замер переносится на заключение договора.</div><div class="item set_add"><b>Установка</b>Новая заявка на установку изделий.</div>',
...
{op:"invoice_set",invoice_id:c,sum:f?0:$("#sum").val(),cash:a.join(":")};f||REGEXP_CENA.test(a.sum)?(h.process(),$.post(AJAX_MAIN,a,function(a){a.success?($("#cash-spisok").html(a.c),$("#invoice-spisok").html(a.i),h.close(),_msg("Баланс установлен.")):h.abort()},"json")):(b("Некорректно указана сумма"),$("#sum").focus())}function b(a){h.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:72})}window.CASH||(window.CASH=[]);var c=$(this).attr("val"),d='<table class="_dialog-tab">',
e=CASH.length,f="1"==c&&!!e;if(f){for(n=0;n<e;n++)d+='<tr><td class="label">'+CASH[n].name+':<td><INPUT type="text" class="money" maxlength="11" value="'+CASH[n].sum+'"> руб.';d+='<tr><td class="label">Счёт <b>'+INVOICE_NAME+'</b>:<td><b id="summa">0</b> руб.'}else d+='<tr><td class="label">Сумма:<td><INPUT type="text" class="money" id="sum" maxlength="11"> руб.';var h=_dialog({width:320,head:"Установка текущей суммы счёта",content:d+"</table>",butSubmit:"Установить",submit:a}),g=h.content.find("input");
g.eq(0).focus();g.keyEnter(a);f&&g.keyup(function(){var a=0;for(n=0;n<e;n++){var b=g.eq(n).val();if(REGEXP_CENA.test(b))a+=1*b.replace(",",".");else{a=0;break}}$("#summa").html(a)})}).on("click","#report.invoice .img_note",function(){var a=_dialog({top:20,width:570,head:"История операций со счётом",load:1,butSubmit:"",butCancel:"Закрыть"}),b={op:"invoice_history",invoice_id:$(this).attr("val")};$.post(AJAX_MAIN,b,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click",".invoice-history ._next",
