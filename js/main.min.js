...
b);return!1}function c(){var a=q[m-1],a='<tr><td class="label">'+m+'-й платёж:<td><input type="text" class="cutsum" id="i'+m+'" maxlength="7" value="'+(a?a[0]:"")+'"> руб. <input type="hidden" id="d'+m+'" value="'+(a?a[1]:"")+'">';$("#cut-add").before(a);1!=m||q[0]||$("#i1").val($("#cut-itog").html());$("#i"+m).focus().keyup(d);$("#d"+m)._calendar();m++}function d(){var a=$(".cutsum"),d=0,b,c=[];for(h=0;h<a.length;h++)if((b=$.trim(a.eq(h).val()))&&0!=b){if(!REGEXP_CENA.test(b)){d=!1;break}d+=1*b;
c.push(1*b+":"+a.eq(h).next().find("input").val())}!1===d&&(d=Math.round(100*d)/100);$("#cut-itog").html(d);return!1===d?"error":c}function g(){var a=d();"error"==a?s.bottom.vkHint({msg:'<span class="red">Некорректно заполнено поле платежа</span>',top:-47,left:84,indent:50,show:1,remove:1}):(DOG.cut=a.join(),f(),s.close())}function f(){var a=DOG.cut?DOG.cut.split(",").length:0;$("#cut").html(a?"Указан"+_end(a,["а","ы"])+" дат"+_end(a,["а","ы"])+" для "+a+_end(a,["-го","-х","-и"])+" платеж"+_end(a,
["а","ей"])+'. <u>Изменить</u><div class="img_del'+_tooltip("Отменить разбивку",-61)+"</div>":p);a&&$("#cut .img_del").click(function(a){a.stopPropagation();DOG.cut="";$("#cut").html(p)})}function e(a,d,b){r.bottom.vkHint({msg:'<span class="red">'+a+"</span>",top:b?-86:-47,left:b?173:142,indent:50,show:1,remove:1});d&&$("#"+d).focus()}var h,k="Заключение",l="Заключить договор",p="Указать даты очередных платежей",m,s,q;switch(a){default:a="create";case "create":break;case "edit":k="Изменение данных";
...
"salary_all_check"!=c.attr("id")&&(g++,c=c.parent().parent(),e.push(c.attr("val")),f+=1*c.find(".sum").html());g&&(d="Выбран"+_end(g,["","о"])+" <b>"+g+"</b> платеж"+_end(g,["","а","ей"])+" на сумму <b>"+f+'</b> руб.<a class="salary-list" val="'+e.join()+'">Распечатать лист выдачи з/п</a>');$("#salary-sel").html(d)};
...
$.fn.productList=function(a){function b(a){var d=g+f,b=d+"id",e=d+"subid",h=d+"count";p.before('<table id="ptab'+f+'" class="ptab" val="'+f+'"><tr><td class="td"><input type="hidden" id="'+b+'" value="'+(a[0]||0)+'" /><input type="hidden" id="'+e+'" value="'+(a[1]||0)+'" /><td class="td"><input type="text" id="'+h+'" value="'+(a[2]||"")+'" class="count" maxlength="3" /> шт.'+(1<f?'<div class="img_del"></div>':"")+"</table>");var k=$("#ptab"+f);k.find(".img_del").click(function(){k.remove()});$("#"+
b)._select({width:119,title0:"Не указано",spisok:PRODUCT_SPISOK,func:function(a){$("#"+e)._select("remove").val(0);0<a&&PRODUCT_SUB_SPISOK[a]&&c(a,e,h);$("#"+h).val(0<a?1:"").focus()}});c(a[0]||0,e,h);f++}function c(a,d,b){0!=a&&PRODUCT_SUB_SPISOK[a]&&$("#"+d)._select({width:120,title0:"Подвид не указан",spisok:PRODUCT_SUB_SPISOK[a],func:function(){$("#"+b).focus()}})}var d=$(this),g=d.attr("id"),f=1,e;if("string"==typeof a&&"get"==a){a=d.find(".ptab");d=[];for(e=0;e<a.length;e++){var h=a.eq(e),k=
...
butSubmit:"Применить",submit:a});$("#sum").focus().keyEnter(a)}).on("click",".salary ._next",function(){var a=$(this),b={op:"salary_spisok",page:$(this).attr("val"),worker_id:WORKER_ID};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".salary ._check:not(#salary_all_check)",salaryCheck).on("click",".salary #salary_all_check",function(){var a,b=$(this).find("input").val(),c=$(".to-all");for(a=0;a<
c.length;a++)c.eq(a).find("._check input:first")._check(b);salaryCheck()}).on("click",".salary-list",function(){var a=$(this).attr("val");a&&(location.href=SITE+"/view/salary_list.php?"+VALUES+"&worker_id="+WORKER_ID+"&ids="+a)}).ready(function(){$("#pin-enter").length&&($("#pin").focus().keydown(function(){$(".red").html("&nbsp;")}).keyEnter(pinEnter),$(".vkButton").click(pinEnter));$("#client").length&&(window.cFind=$("#find")._search({width:602,focus:1,enter:1,txt:"Начните вводить данные клиента",
...
ugol:"right",width:150,top:-6,left:-185,indent:20,delayShow:1E3,correct:0}),$("#note")._check(clientSpisok),$("#product_id")._select({width:140,title0:"Любые изделия",spisok:PRODUCT_SPISOK,func:clientSpisok}));$("#clientInfo").length&&($("#dopLinks .link").click(function(){$("#dopLinks .link").removeClass("sel");$(this).addClass("sel");var a=$(this).attr("val");$(".res").css("display","zayav"==a?"block":"none");$("#zayav_filter").css("display","zayav"==a?"block":"none");$("#zayav_spisok").css("display",
"zayav"==a?"block":"none");$("#income_spisok").css("display","money"==a?"block":"none");$("#remind_spisok").css("display","remind"==a?"block":"none");$("#comments").css("display","comm"==a?"block":"none");$("#histories").css("display","hist"==a?"block":"none")}),$(".cedit").click(function(){function a(){var d={op:"client_edit",client_id:CLIENT.id,fio:$("#fio").val(),telefon:$("#telefon").val(),adres:$("#adres").val(),pasp_seria:$("#pasp_seria").val(),pasp_nomer:$("#pasp_nomer").val(),pasp_adres:$("#pasp_adres").val(),
pasp_ovd:$("#pasp_ovd").val(),pasp_data:$("#pasp_data").val()};d.fio?(b.process(),$.post(AJAX_MAIN,d,function(a){a.success?(CLIENT=a,$(".left:first").html(a.html),b.close(),_msg("Данные клиента изменены.")):b.abort()},"json")):(b.bottom.vkHint({msg:'<span class="red">Не указано имя клиента.</span>',top:-47,left:100,indent:50,show:1,remove:1}),$("#fio").focus())}var b=_dialog({head:"Редактирование данных клиента",top:30,width:380,content:'<table class="client-add"><tr><td class="label">Имя:<td><input type="text" id="fio" maxlength="100" value="'+
CLIENT.fio+'"><tr><td class="label">Телефон:<td><input type="text" id="telefon" maxlength="100" value="'+CLIENT.telefon+'"><tr><td class="label">Адрес:<td><input type="text" id="adres" maxlength="100" value="'+CLIENT.adres+'"><tr><td><td><b>Паспортные данные:</b><tr><td class="label">Серия:<td><input type="text" id="pasp_seria" maxlength="8" value="'+CLIENT.pasp_seria+'"><span class="label">Номер:</span><input type="text" id="pasp_nomer" maxlength="10" value="'+CLIENT.pasp_nomer+'"><tr><td class="label">Прописка:<td><input type="text" id="pasp_adres" maxlength="100" value="'+
CLIENT.pasp_adres+'"><tr><td class="label">Кем выдан:<td><input type="text" id="pasp_ovd" maxlength="100" value="'+CLIENT.pasp_ovd+'"><tr><td class="label">Когда выдан:<td><input type="text" id="pasp_data" maxlength="100" value="'+CLIENT.pasp_data+'"></table>',butSubmit:"Сохранить",submit:a});$("#fio,#telefon,#adres,#pasp_seria,#pasp_nomer,#pasp_adres,#pasp_ovd,#pasp_data").keyEnter(a)}),$(".cdel").click(function(){var a=_dialog({top:90,width:300,head:"Удаление клиента",content:"<center>Внимание!<br />Будут удалены все данные о клиенте,<br />его заявки, платежи и задачи.<br /><b>Подтвердите удаление.</b></center>",
...
$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val()};d.category||d.about?d.invoice?REGEXP_CENA.test(d.sum)&&0!=d.sum?(e.process(),$.post(AJAX_MAIN,d,function(a){a.success?(e.close(),_msg("Новый расход внесён."),expenseSpisok()):e.abort()},"json")):(b("Некорректно указана сумма."),$("#sum").focus()):b("Укажите с какого счёта производится оплата."):(b("Выберите категорию или укажите описание."),$("#about").focus())}function b(a){e.bottom.vkHint({msg:'<SPAN class="red">'+
