...
a.addClass("busy");$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).on("click","#dog_next",function(){var a=$(this);if(!a.hasClass("busy")){var b=dogovorFilter();b.op="dog_next";b.page=a.attr("val");a.addClass("busy");$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).on("click",".set_add",function(){"undefined"==typeof CLIENT&&(CLIENT={id:0,fio:"",adres:""});var a=CLIENT.adres,b=_dialog({width:550,
...
"")+"</div>",butSubmit:"",butCancel:"Закрыть"});$("#day")._calendar({lost:1});$(".st").click(function(){var b=$(this),c={op:"set_status",zayav_id:ZAYAV.id,status:b.attr("val"),day:$("#day").val()||""},d=b.parent();d.hasClass("busy")||(d.addClass("busy"),$.post(AJAX_MAIN,c,function(b){b.success?(a.close(),_msg("Данные изменены!"),document.location.reload()):d.removeClass("busy")},"json"))})}).on("click","#set_next",function(){var a=$(this);if(!a.hasClass("busy")){var b=setFilter();b.op="set_next";
b.page=a.attr("val");a.addClass("busy");$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).on("click",".remind_calendar .on",function(){var a=$(this),b=a.parent().parent(),a={op:"remind_day",day:a.attr("val")};b.hasClass("busy")||(b.addClass("busy"),$.post(AJAX_MAIN,a,function(a){a.success&&($("#remind .left").html(a.html),$("#remind").removeClass("y"));b.removeClass("busy")},"json"))}).on("click","#remind .fmon",function(){var a=$(this);$(".right .remind_calendar").html(a.next().html());
