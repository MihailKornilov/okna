...
c.find(".ptab");c=[];for(g=0;g<a.length;g++){var f=a.eq(g),h=d+f.attr("val"),k=$("#"+h+"cat").val(),l=f.find(".zrsum").val(),m="";if(0!=k){if(!REGEXP_NUMERIC.test(l)||0==l)return"sum_error";ZAYAVEXPENSE_TXT[k]?m=f.find(".zrtxt").val():ZAYAVEXPENSE_WORKER[k]&&(m=$("#"+h+"worker").val());c.push(k+":"+m+":"+l+":"+$("#"+h+"list").val())}}return c.join()}c.html('<div class="_zayav-rashod"></div>');var n=c.find("._zayav-rashod");if("object"==typeof a)for(g=0;g<a.length;g++)b(a[g]);b();return c};
...
butSubmit:"Сохранить",submit:function(){var b={op:"zayav_expense_edit",zayav_id:ZAYAV.id,rashod:$("#zrs").zayavExpense("get")};"sum_error"==b.rashod?a.bottom.vkHint({msg:'<SPAN class="red">Некорректно указана сумма</SPAN>',top:-47,left:167,indent:40,show:1,remove:1}):(a.process(),$.post(AJAX_MAIN,b,function(b){b.success?($(".zrashod").html(b.html),$("#hspisok").html(b.history),ZAYAV.rashod=b.array,a.close(),_msg("Сохранено.")):a.abort()},"json"))}});$("#zrs").zayavExpense(ZAYAV.rashod)}),$(".zakaz-to-set").click(function(){function a(){var c=
