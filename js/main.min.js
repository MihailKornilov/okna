...
c.after('<div class="red">Некорректный файл.</div>'),c.next(".red").fadeOut(4E3)))},500);c.addClass("_busy");b.submit()}).on("click","._attach .img_minidel",function(){var a=$(this),b={op:"attach_del",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){b.success&&(a.prev().remove(),a.remove())},"json")}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,type:$("#income_id").val(),sum:$("#sum").val(),zayav_id:$("#zayav_id").val(),client_id:OPL.client_id,prim:$.trim($("#prim").val())};
...
indent:40,show:1,top:-48,left:62}),$("#sum").focus())}var b=$(this),c=_dialog({width:300,top:60,head:"Установка начального баланса счёта",content:'<table style="border-spacing:10px"><tr><td class="label">Сумма:<td><INPUT type="text" class="money" id="sum" maxlength="7"> руб.</table>',butSubmit:"Установить",submit:a});$("#sum").focus().keyEnter(a)}).on("click",".income_mon",function(){}).on("click","#money_next",function(){if(!$(this).hasClass("busy")){var a=$(this),b={op:"income_next",page:$(this).attr("val"),
limit:$("#money_limit").val(),client_id:$("#money_client_id").val(),zayav_id:$("#money_zayav_id").val(),day:$("._calendarFilter .selected").val()||""};a.addClass("busy");$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json")}}).on("click","#report_month .yr",function(){$(this).next().toggle()}).on("click","#setup_my .pinset",function(){function a(){var a={op:"setup_my_pinset",pin:$.trim($("#pin").val())};a.pin?3>a.pin.length?(b("Длина пин-кода от 3 до 10 символов"),
...
top:-75,left:163,indent:60,delayShow:400})}));0<$("#remind").length&&($(".goyear").click(function(){$("#remind").addClass("y")}),window._calendarFilter=function(a){var b=$("#remind").hasClass("y"),c=$("#remind .right ._calendarFilter");a={op:"remind_day",day:a};b&&$("#remind").removeClass("y");$.post(AJAX_MAIN,a,function(a){a.success&&($("#remind .left").html(a.html),b&&c.html(a.cal))},"json")});0<$("#income").length&&(window._calendarFilter=function(a){send={op:"income_get",day:a};$.post(AJAX_MAIN,
send,function(a){a.success&&($("#income .inc-path").html(a.path),$("#income #spisok").html(a.html))},"json")});0<$("#setup_rules").length&&($(".gtab-save").click(function(){function a(b){c.vkHint({msg:'<SPAN class="red">'+b+"</SPAN>",top:-57,left:-6,indent:40,show:1,remove:1})}var b={op:"setup_worker_save",viewer_id:RULES_VIEWER_ID,first_name:$("#first_name").val(),last_name:$("#last_name").val(),post:$("#post").val()},c=$(this);b.first_name?b.last_name?(c.addClass("busy"),$.post(AJAX_MAIN,b,function(a){c.removeClass("busy");
a.success&&_msg("Сохранено.")},"json")):(a("Не указана фамилия"),$("#last_name").focus()):(a("Не указано имя"),$("#first_name").focus())}),$(".pin-clear").click(function(){var a={op:"setup_worker_pinclear",viewer_id:RULES_VIEWER_ID},b=$(this);b.addClass("busy");$.post(AJAX_MAIN,a,function(a){b.removeClass("busy");a.success&&_msg("Пин-код сброшен.")},"json")}),$("#rules_appenter")._check(function(a,b){$(".app-div")[(0==a?"add":"remove")+"Class"]("dn");setupRulesSet(a,b);$("#rules_worker")._check(0);
$("#rules_product")._check(0);$("#rules_income")._check(0);$("#rules_zayavrashod")._check(0);$("#rules_historyshow")._check(0)}),$("#rules_worker")._check(setupRulesSet),$("#rules_rekvisit")._check(setupRulesSet),$("#rules_product")._check(setupRulesSet),$("#rules_income")._check(setupRulesSet),$("#rules_zayavrashod")._check(setupRulesSet),$("#rules_historyshow")._check(setupRulesSet));0<$("#setup_rekvisit").length&&$(".vkButton").click(function(){var a=$(this),b={op:"setup_rekvisit",org_name:$("#org_name").val(),
