...
avans:$("#avans").val(),cut:DOG.cut,reason:"reneg"==a?$("#reason").val():""};if(d.fio)if(REGEXP_NUMERIC.test(d.nomer)&&0!=d.nomer)if(REGEXP_CENA.test(d.sum)&&0!=d.sum)if(d.avans&&!REGEXP_CENA.test(d.avans))e("Некорректно указан авансовый платёж","avans",b);else{if("reneg"!=a||d.reason)return d;e("Не указана причина перезаключения договора","reason",b)}else e("Некорректно указана сумма по договору","sum",b);else e("Некорректно указан номер договора","nomer",b);else e("Не указано Фио клиента","fio",
b);return!1}function c(){var a=q[m-1],a='<tr><td class="label">'+m+'-й платёж:<td><input type="text" class="cutsum" id="i'+m+'" maxlength="7" value="'+(a?a[0]:"")+'"> руб. <input type="hidden" id="d'+m+'" value="'+(a?a[1]:"")+'">';$("#cut-add").before(a);1!=m||q[0]||$("#i1").val($("#cut-itog").html());$("#i"+m).focus().keyup(d);$("#d"+m)._calendar();m++}function d(){var a=$(".cutsum"),b=0,d,c=[];for(h=0;h<a.length;h++)if((d=$.trim(a.eq(h).val()))&&0!=d){if(!REGEXP_CENA.test(d)){b=!1;break}b+=1*d;
c.push(1*d+":"+a.eq(h).next().find("input").val())}!1===b&&(b=Math.round(100*b)/100);$("#cut-itog").html(b);return!1===b?"error":c}function f(){var a=d();"error"==a?s.bottom.vkHint({msg:'<span class="red">Некорректно заполнено поле платежа</span>',top:-47,left:84,indent:50,show:1,remove:1}):(DOG.cut=a.join(),g(),s.close())}function g(){var a=DOG.cut?DOG.cut.split(",").length:0;$("#cut").html(a?"Указан"+_end(a,["а","ы"])+" дат"+_end(a,["а","ы"])+" для "+a+_end(a,["-го","-х","-и"])+" платеж"+_end(a,
["а","ей"])+'. <u>Изменить</u><div class="img_del'+_tooltip("Отменить разбивку",-61)+"</div>":p);a&&$("#cut .img_del").click(function(a){a.stopPropagation();DOG.cut="";$("#cut").html(p)})}function e(a,b,d){r.bottom.vkHint({msg:'<span class="red">'+a+"</span>",top:d?-86:-47,left:d?173:142,indent:50,show:1,remove:1});b&&$("#"+b).focus()}var h,k="Заключение",l="Заключить договор",p="Указать даты очередных платежей",m,s,q;switch(a){default:a="create";case "create":break;case "edit":k="Изменение данных";
...
DOG.pasp_nomer+'" /><tr><td><td><span class="l">Прописка:</span><input type="text" id="pasp_adres" maxlength="100" value="'+DOG.pasp_adres+'" /><tr><td><td><span class="l">Кем выдан:</span><input type="text" id="pasp_ovd" maxlength="100" value="'+DOG.pasp_ovd+'" /><tr><td><td><span class="l">Когда выдан:</span><input type="text" id="pasp_data" maxlength="100" value="'+DOG.pasp_data+'" /><tr><td class="label">Номер договора:<td><input type="text" id="nomer" maxlength="6" value="'+DOG.nomer+'" /><tr><td class="label">Дата заключения:<td><input type="hidden" id="data_create" value="'+
(DOG.data_create?DOG.data_create:"")+'" /><tr><td class="label">Сумма по договору:<td><input type="text" id="sum" class="money" maxlength="11" value="'+(DOG.sum?DOG.sum:"")+'" /> руб.<tr><td class="label">Авансовый платёж:<td><input type="text" id="avans" class="money" maxlength="11" value="'+(DOG.avans?DOG.avans:"")+'" /> руб. <span class="prim">(не обязательно)</span>'+("reneg"==a?'<tr><td class="label">Причина перезаключения:<td><input type="text" id="reason" />':"")+'<tr><td colspan="2"><a id="cut"></a><tr><td colspan="2"><a id="preview">Предварительный просмотр договора</a><form action="'+
AJAX_MAIN+'" method="post" id="preview-form" target="_blank"></form></table>',butSubmit:l,submit:function(){var d=b();d&&(d.op="dogovor_"+a,r.process(),$.post(AJAX_MAIN,d,function(a){a.success?(r.close(),_msg("Договор заключен."),document.location.reload()):(r.abort(),e(a.text))},"json"))}});$("#data_create")._calendar({lost:1});$("#cut").click(function(){var a=REGEXP_CENA.test($("#sum").val())?$("#sum").val():0,b=REGEXP_CENA.test($("#avans").val())?$("#avans").val():0,a=a-b;s=_dialog({head:"Разбивка платежа на части",
content:'<table class="cut-money"><tr><td class="label">Исходная сумма:<td><u>'+a+'</u> руб.<tr id="cut-add"><td><td><a>Добавить поле</a><tr><td class="label">Итоговая сумма:<td><b id="cut-itog">'+a+"</b> руб.</table>",butSubmit:"Применить",submit:f});m=1;q=[];if(DOG.cut)for(a=DOG.cut.split(","),h=0;h<a.length;h++)b=a[h].split(":"),q.push([b[0],b[1]]),c();else c();d();$("#cut-add a").click(c)}).vkHint({width:180,msg:"Разбить оставшуюся сумму платежа по заявке на части и создать по ним напоминания.",
delayShow:400,top:-82,left:118});g();$("#preview").click(function(){var a=b("preview");if(a){a.op="dogovor_preview";var d="",c;for(c in a)d+='<input type="hidden" name="'+c+'" value="'+a[c]+'">';$("#preview-form").html(d).submit()}});$("#reason").autosize()},historyFilter=function(){return{op:"history_spisok",limit:$("#history_limit").val(),worker_id:$("#history_worker_id").val(),cat_id:$("#history_cat_id").val(),client_id:$("#history_client_id").val(),zayav_id:$("#history_zayav_id").val()}},historySpisok=
function(a,b){var c=historyFilter();c[b]=a;$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,c,function(a){$("#mainLinks").removeClass("busy");a.success&&$(".left").html(a.html)},"json")},incomeSpisok=function(){var a={op:"income_spisok",day:$(".selected").val(),income_id:$("#income_id").val(),worker_id:$("#worker_id").val()};$(".inc-path").addClass("_busy");$.post(AJAX_MAIN,a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},
incomeChoiceSum=function(){var a,b=$("._money .choice"),c=0,d=0,f=!0,g=[];for(a=0;a<b.length;a++){var e=b.eq(a);1==e.find("input").val()?(c++,d+=1*e.parent().find(".sum").html().replace(" ",""),g.push(e.parent().attr("val"))):f=!1}$(".income_choice_sum").html(c?"Выбран"+_end(c,["","о"])+" <b>"+c+"</b> платеж"+_end(c,["","а","ей"])+" на сумму <b>"+d+"</b> руб.":"");$("#money_all")._check(f);return{count:c,ids:g.join(),sum:d}},expenseFilter=function(){for(var a=[],b=$("#monthList input"),c=1;12>=c;c++)1==
b.eq(c-1).val()&&a.push(c);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")},salaryCheck=function(){var a=$("._check"),b,c,d="",f=0,g=0,e=[];for(b=0;b<a.length;b++)c=a.eq(b),0!=c.find("input").val()&&
"salary_all_check"!=c.attr("id")&&(f++,c=c.parent().parent(),e.push(c.attr("val")),g+=1*c.find(".sum").html());f&&(d="Выбран"+_end(f,["а","о"])+" <b>"+f+"</b> запис"+_end(f,["ь","и","ей"])+" на сумму <b>"+g+'</b> руб.<a class="salary-list" val="'+e.join()+'">Распечатать лист выдачи з/п</a>');$("#salary-sel").html(d)},salarySpisok=function(){if(!$(".headName").hasClass("_busy")){MON=1*$("#salmon").val();YEAR=$("#year").val();var a={op:"salary_spisok",worker_id:WORKER_ID,year:YEAR,mon:MON};$(".headName").addClass("_busy");
$.post(AJAX_MAIN,a,function(a){$(".headName").removeClass("_busy");a.success&&($(".headName em").html(MONTH_DEF[MON]+" "+YEAR),$("#spisok").html(a.html),$("#monthList").html(a.month))},"json")}};
...
"")+"</div>",butSubmit:"",butCancel:"Закрыть"});$("#day")._calendar({lost:1});$(".st").click(function(){var b=$(this),c={op:"set_status",zayav_id:ZAYAV.id,status:b.attr("val"),day:$("#day").val()||""},d=b.parent();d.hasClass("busy")||(d.addClass("busy"),$.post(AJAX_MAIN,c,function(b){b.success?(a.close(),_msg("Данные изменены!"),document.location.reload()):d.removeClass("busy")},"json"))})}).on("click",".cut_status",function(){function a(a){a={op:"remind_status",id:b.attr("val"),status:a,day:$("#remind_day").val()};
$.post(AJAX_MAIN,a,function(a){a.success&&(c.close(),_msg("Данные изменены!"),$(".left").html(a.html))},"json")}var b=$(this),c=_dialog({top:30,head:"Изменение статуса напоминания",content:'<div class="zayav-status remind-status"><div class="st c1" val="1">Указать другой день<div class="about">Перенести напоминание на другой день.</div></div><div class="st c2" val="2">Выполнено<div class="about">Задание выполнено успешно.</div></div><div class="st c0" val="0">Отмена<div class="about">Отмена напоминания по какой-либо причине.</div></div><table class="zstab"><tr><td class="label">Новый день:<td><input type="hidden" id="remind_day" /><tr><td><td><div class="vkButton"><button>Применить</button></div></table></div>',
butSubmit:"",butCancel:"Закрыть"});$("#remind_day")._calendar();$(".st").click(function(){var b=$(this).attr("val");1==b?($(".c2,.c0").hide(),$(".zstab").show()):a(b)});$(".remind-status .vkButton").click(function(){$(this).addClass("busy");a(1)})}).on("click","#history_next",function(){var a=$(this),b=historyFilter();a.hasClass("busy")||(b.page=$(this).attr("val"),a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".invoice_set",
function(){function a(){var a=[];if(g)for(n=0;n<f;n++){var d=h.eq(n).val();if(REGEXP_CENA.test(d))a.push(CASH[n].id+"="+1*d.replace(",","."));else{b("Некорректно указана сумма");h.eq(n).focus();return}}a={op:"invoice_set",invoice_id:c,sum:g?0:$("#sum").val(),cash:a.join(":")};g||REGEXP_CENA.test(a.sum)?(e.process(),$.post(AJAX_MAIN,a,function(a){a.success?($("#cash-spisok").html(a.c),$("#invoice-spisok").html(a.i),e.close(),_msg("Баланс установлен.")):e.abort()},"json")):(b("Некорректно указана сумма"),
$("#sum").focus())}function b(a){e.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:72})}window.CASH||(window.CASH=[]);var c=$(this).attr("val"),d='<table class="_dialog-tab">',f=CASH.length,g="1"==c&&!!f;if(g){for(n=0;n<f;n++)d+='<tr><td class="label">'+CASH[n].name+':<td><INPUT type="text" class="money" maxlength="11" value="'+CASH[n].sum+'"> руб.';d+='<tr><td class="label">Счёт <b>'+INVOICE_NAME+'</b>:<td><b id="summa">0</b> руб.'}else d+='<tr><td class="label">Сумма:<td><INPUT type="text" class="money" id="sum" maxlength="11"> руб.';
var e=_dialog({width:320,head:"Установка текущей суммы счёта",content:d+"</table>",butSubmit:"Установить",submit:a}),h=e.content.find("input");h.eq(0).focus();h.keyEnter(a);g&&h.keyup(function(){var a=0;for(n=0;n<f;n++){var b=h.eq(n).val();if(REGEXP_CENA.test(b))a+=1*b.replace(",",".");else{a=0;break}}$("#summa").html(a)})}).on("click","#report.invoice .img_note",function(){var a=_dialog({top:20,width:570,head:"История операций со счётом",load:1,butSubmit:"",butCancel:"Закрыть"}),b={op:"invoice_history",
invoice_id:$(this).attr("val")};$.post(AJAX_MAIN,b,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click",".invoice-history ._next",function(){var a=$(this),b={op:"invoice_history",page:a.attr("val"),invoice_id:$("#invoice_history_id").val()};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click","#money_all_check",function(){for(var a=$(this),b=a.find("input").val();!a.hasClass("_money");)a=
a.parent();for(var c=a.find("tr"),a=1;a<c.length;a++)c.eq(a).find("input:first")._check(b)}).on("click",".inc ._check",incomeChoiceSum).on("click",".transfer-show",function(){var a=_dialog({top:20,width:480,head:"Просмотр подтверждённых переводов",load:1,butSubmit:"",butCancel:"Закрыть"}),b={op:"transfer_show",ids:$(this).attr("val")};$.post(AJAX_MAIN,b,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click",".income-confirm",function(){var a=_dialog({top:20,width:480,head:"Подтверждение платежей",
...
'<div class="income_choice_sum"></div>'):a.loadError()},"json")}).on("click",".transfer-confirm",function(){var a=_dialog({top:20,width:520,head:"Подтверждение переводов",load:1,butSubmit:"Подтвердить",submit:function(){for(var b=a.content.find("._check"),c=[],d=0;d<b.length;d++){var f=b.eq(d).find("input");1==f.val()&&c.push(f.attr("id").split("_")[0])}c.length?(b={op:"transfer_confirm",ids:c.join()},a.process(),$.post(AJAX_MAIN,b,function(b){b.success?($("#invoice-spisok").html(b.i),a.close(),_msg("Переводы подтверждены.")):
a.abort()},"json")):a.bottom.vkHint({msg:'<SPAN class="red">Платежи не выбраны</SPAN>',remove:1,indent:50,show:1,top:-48,left:163})}});$.post(AJAX_MAIN,{op:"transfer_confirm_get"},function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click",".income-show",function(){var a=_dialog({top:20,width:480,head:"Просмотр платежей",load:1,butSubmit:"",butCancel:"Закрыть"}),b={op:"income_transfer_show",ids:$(this).attr("val")};$.post(AJAX_MAIN,b,function(b){b.success?a.content.html(b.html):
a.loadError()},"json")}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,type:$("#income_opl").val(),confirm:$("#confirm").val(),sum:$("#sum").val(),zayav_id:$("#zayav_id").val()||0,client_id:OPL.client_id||0,prim:$.trim($("#prim").val())};0==a.type?b("Не указан вид платежа"):REGEXP_CENA.test(a.sum)&&0!=a.sum?$("#zayav_id").length&&0==a.zayav_id&&!a.prim?(b("Если не выбрана заявка, необходимо указать комментарий"),$("#prim").focus()):$("#zayav_id").length||a.prim?
(d.process(),$.post(AJAX_MAIN,a,function(a){if(a.success)switch(d.close(),_msg("Платёж успешно внесён!"),OPL.from){case "client":$("#income_spisok").html(a.html);$(".left:first").html(a.balans);break;case "zayav":$("#income_spisok").html(a.html);break;case "income":incomeSpisok()}else d.abort()},"json")):(b("Необходимо указать комментарий"),$("#prim").focus()):(b("Некорректно указана сумма."),$("#sum").focus())}function b(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,
show:1,top:-48,left:135})}var c='<table class="income-add-tab">'+("income"!=OPL.from?'<tr><td class="label">Клиент:<td>'+OPL.client_fio+'<tr><td class="label">Заявка:<td><input type="hidden" id="zayav_id" value="'+(OPL.zayav_id?OPL.zayav_id:0)+'">'+(OPL.zayav_id?"<b>№"+OPL.zayav_id+"</b>":""):"")+'<tr><td class="label">Вид платежа:<td><input type="hidden" id="income_opl"><a href="'+URL+'&p=setup&d=income" class="img_edit'+_tooltip("Настройка видов платежей",-85)+'</a><tr class="tr_confirm dn"><td class="label">Подтверждение:<td><input type="hidden" id="confirm"><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11"> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100"></table>',
