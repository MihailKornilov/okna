...
a,function(a){a.success?document.location.href=URL:($(".vkButton").removeClass("busy"),$("#pin").val(""),$(".red").html(a.text))},"json"))},clientAdd=function(a){function b(){var c={op:"client_add",fio:$("#fio").val(),telefon:$("#telefon").val(),adres:$("#adres").val(),pasp_seria:$("#pasp_seria").val(),pasp_nomer:$("#pasp_nomer").val(),pasp_adres:$("#pasp_adres").val(),pasp_ovd:$("#pasp_ovd").val(),pasp_data:$("#pasp_data").val()};c.fio?(dialog.process(),$.post(AJAX_MAIN,c,function(d){d.success?(dialog.close(),
...
"json")},incomeChoiceSum=function(){var a,b=$("._money .choice"),c=0,d=0,f=!0,e=[];for(a=0;a<b.length;a++){var g=b.eq(a);1==g.find("input").val()?(c++,d+=1*g.parent().find(".sum").html().replace(" ",""),e.push(g.parent().attr("val"))):f=!1}$(".income_choice_sum").html(c?"Выбрано <b>"+c+"</b> платеж"+_end(c,["","а","ей"])+" на сумму <b>"+d+"</b> руб.":"");$("#money_all")._check(f);return{count:c,ids:e.join(),sum:d}},expenseFilter=function(){for(var a=[],b=$("#monthList input"),c=1;12>=c;c++)1==b.eq(c-
1).val()&&a.push(c);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")};
...
$.fn.productList=function(a){function b(a){var d=f+e,b=d+"id",g=d+"subid",h=d+"count";m.before('<table id="ptab'+e+'" class="ptab" val="'+e+'"><tr><td class="td"><input type="hidden" id="'+b+'" value="'+(a[0]||0)+'" /><input type="hidden" id="'+g+'" value="'+(a[1]||0)+'" /><td class="td"><input type="text" id="'+h+'" value="'+(a[2]||"")+'" class="count" maxlength="3" /> шт.'+(1<e?'<div class="img_del"></div>':"")+"</table>");var k=$("#ptab"+e);k.find(".img_del").click(function(){k.remove()});$("#"+
b)._select({width:119,title0:"Не указано",spisok:PRODUCT_SPISOK,func:function(a){$("#"+g)._select("remove").val(0);0<a&&PRODUCT_SUB_SPISOK[a]&&c(a,g,h);$("#"+h).val(0<a?1:"").focus()}});c(a[0]||0,g,h);e++}function c(a,d,b){0!=a&&PRODUCT_SUB_SPISOK[a]&&$("#"+d)._select({width:120,title0:"Подвид не указан",spisok:PRODUCT_SUB_SPISOK[a],func:function(){$("#"+b).focus()}})}var d=$(this),f=d.attr("id"),e=1,g;if("string"==typeof a&&"get"==a){a=d.find(".ptab");d=[];for(g=0;g<a.length;g++){var h=a.eq(g),k=
f+h.attr("val"),h=$("#"+k+"id").val(),l=$("#"+k+"subid").val(),k=$("#"+k+"count").val();if(0!=h){if(!REGEXP_NUMERIC.test(k)||0==k)return"count_error";d.push(h+":"+l+":"+k)}}return 0==d.length?!1:d.join()}d.html('<div class="_product-list"><a class="add">Добавить поле</a></div>');var m=d.find(".add");m.click(b);if("object"==typeof a)for(g=0;g<a.length;g++)b(a[g]);else b([]);return d};
$.fn.zayavRashod=function(a){function b(a){var c=d+f,e=c+"cat",g=c+"worker";p.append('<table id="ptab'+f+'" class="ptab" val="'+f+'"><tr><td><input type="hidden" id="'+e+'" value="'+(a[0]||0)+'" /><td class="tddop">'+(a[0]&&ZAYAVRASHOD_TXT_ASS[a[0]]?'<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*f-1)+'" value="'+a[1]+'" />':"")+(a[0]&&ZAYAVRASHOD_WORKER_ASS[a[0]]?'<input type="hidden" id="'+g+'" value="'+a[1]+'" />':"")+'<td class="tdsum'+(a[0]?"":" dn")+'"><input type="text" class="zrsum" maxlength="6" tabindex="'+
10*f+'" value="'+(a[2]||"")+'" />руб.</table>');var h=$("#ptab"+f),k=h.find(".tddop"),l=h.find(".zrsum");a[0]&&ZAYAVRASHOD_WORKER_ASS[a[0]]&&$("#"+g)._select({width:150,title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(){l.focus()}});$("#"+e)._select({width:120,title0:"Категория",spisok:ZAYAVRASHOD_SPISOK,func:function(a){h.find(".tdsum")[(0<a?"remove":"add")+"Class"]("dn");ZAYAVRASHOD_TXT_ASS[a]?(k.html('<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*f-11)+
'" />'),k.find(".zrtxt").focus()):(ZAYAVRASHOD_WORKER_ASS[a]?(k.html('<input type="hidden" id="'+g+'" />'),$("#"+g)._select({width:150,title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(){l.focus()}})):k.html(""),l.focus());l.val("");0<a&&!h.next().hasClass("ptab")&&b([])}});f++}var c=$(this),d=c.attr("id"),f=1,e;if("string"==typeof a&&"get"==a){a=c.find(".ptab");c=[];for(e=0;e<a.length;e++){var g=a.eq(e),h=d+g.attr("val"),k=$("#"+h+"cat").val();$("#"+h+"worker").val();var l=g.find(".zrsum").val(),
m="";if(0!=k){if(!REGEXP_NUMERIC.test(l)||0==l)return"sum_error";ZAYAVRASHOD_TXT_ASS[k]?m=g.find(".zrtxt").val():ZAYAVRASHOD_WORKER_ASS[k]&&(m=$("#"+h+"worker").val());c.push(k+":"+m+":"+l)}}return c.join()}c.html('<div class="_zayav-rashod"></div>');var p=c.find("._zayav-rashod");if("object"==typeof a)for(e=0;e<a.length;e++)b(a[e]);b([]);return c};
...
a.text+"</SPAN>",top:-58,left:-5,indent:40,remove:1,show:1})},"json")}var c=$(this),d="undefined"!=typeof ZAYAV?ZAYAV.id:c.attr("val"),f=_dialog({width:400,top:30,head:"Изменение статуса замера",load:1,butSubmit:"",butCancel:"Закрыть"});"undefined"==typeof ZAYAV?$.post(AJAX_MAIN,{op:"zamer_info_get",zayav_id:d},function(d){d.success?a(d):f.loadError()},"json"):a(ZAYAV)}).on("click",".set_add",function(){window.CLIENT||(CLIENT={id:0,fio:"",adres:""});var a=CLIENT.adres,b=_dialog({width:550,top:30,
...
a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click",".invoice_set",function(){function a(){var a=[];if(e)for(n=0;n<f;n++){var d=h.eq(n).val();if(REGEXP_CENA.test(d))a.push(CASH[n].id+"="+1*d.replace(",","."));else{b("Некорректно указана сумма");h.eq(n).focus();return}}a={op:"invoice_set",invoice_id:c,sum:e?0:$("#sum").val(),cash:a.join(":")};e||REGEXP_CENA.test(a.sum)?(g.process(),$.post(AJAX_MAIN,a,function(a){a.success?
($("#cash-spisok").html(a.c),$("#invoice-spisok").html(a.i),g.close(),_msg("Баланс установлен.")):g.abort()},"json")):(b("Некорректно указана сумма"),$("#sum").focus())}function b(a){g.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:72})}window.CASH||(window.CASH=[]);var c=$(this).attr("val"),d='<table class="_dialog-tab">',f=CASH.length,e="1"==c&&!!f;if(e){for(n=0;n<f;n++)d+='<tr><td class="label">'+CASH[n].name+':<td><INPUT type="text" class="money" maxlength="11" value="'+
CASH[n].sum+'"> руб.';d+='<tr><td class="label">Счёт <b>'+INVOICE_NAME+'</b>:<td><b id="summa">0</b> руб.'}else d+='<tr><td class="label">Сумма:<td><INPUT type="text" class="money" id="sum" maxlength="11"> руб.';var g=_dialog({width:320,head:"Установка текущей суммы счёта",content:d+"</table>",butSubmit:"Установить",submit:a}),h=g.content.find("input");h.eq(0).focus();h.keyEnter(a);e&&h.keyup(function(){var a=0;for(n=0;n<f;n++){var d=h.eq(n).val();if(REGEXP_CENA.test(d))a+=1*d.replace(",",".");else{a=
...
(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).on("click","#money_all_check",function(){for(var a=$(this),b=a.find("input").val();!a.hasClass("_money");)a=a.parent();for(var c=a.find("tr"),a=1;a<c.length;a++)c.eq(a).find("input:first")._check(b)}).on("click","._money ._check",incomeChoiceSum).on("click",".income-transfer-show",function(){var a=_dialog({top:20,width:480,head:"Просмотр платежей",load:1,butSubmit:"",butCancel:"Закрыть"}),
b={op:"income_transfer_show",ids:$(this).attr("val")};$.post(AJAX_MAIN,b,function(b){b.success?a.content.html(b.html):a.loadError()},"json")}).on("click",".income-add",function(){function a(){var a={op:"income_add",from:OPL.from,type:$("#income_opl").val(),sum:$("#sum").val(),zayav_id:$("#zayav_id").val()||0,client_id:OPL.client_id||0,prim:$.trim($("#prim").val())};0==a.type?b("Не указан вид платежа"):REGEXP_CENA.test(a.sum)&&0!=a.sum?$("#zayav_id").length&&0==a.zayav_id&&!a.prim?(b("Если не выбрана заявка, необходимо указать комментарий"),
$("#prim").focus()):$("#zayav_id").length||a.prim?(c.process(),$.post(AJAX_MAIN,a,function(a){if(a.success)switch(c.close(),_msg("Платёж успешно внесён!"),OPL.from){case "client":$("#income_spisok").html(a.html);$(".left:first").html(a.balans);break;case "zayav":$("#income_spisok").html(a.html);break;case "income":incomeSpisok()}else c.abort()},"json")):(b("Необходимо указать комментарий"),$("#prim").focus()):(b("Некорректно указана сумма."),$("#sum").focus())}function b(a){c.bottom.vkHint({msg:'<SPAN class="red">'+
a+"</SPAN>",remove:1,indent:40,show:1,top:-48,left:135})}var c=_dialog({top:60,width:440,head:"Внесение платежа",content:'<table class="income-add-tab">'+("income"!=OPL.from?'<tr><td class="label">Клиент:<td>'+OPL.client_fio+'<tr><td class="label">Заявка:<td><input type="hidden" id="zayav_id" value="'+(OPL.zayav_id?OPL.zayav_id:0)+'">'+(OPL.zayav_id?"<b>№"+OPL.zayav_id+"</b>":""):"")+'<tr><td class="label">Вид платежа:<td><input type="hidden" id="income_opl"><a href="'+URL+'&p=setup&d=income" class="img_edit" title="Перейти к настройке видов платежей"></a><tr><td class="label">Сумма:<td><input type="text" id="sum" class="money" maxlength="11"> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100"></table>',
...
$("#invoice")._select({title0:"Не выбран",spisok:INVOICE_SPISOK,func:function(){$("#sum").focus()}});$("#sum,#about").keyEnter(a)}).on("click",".salary ._next",function(){var a=$(this),b={op:"salary_spisok",page:$(this).attr("val"),worker_id:WORKER_ID};a.hasClass("busy")||(a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.html).remove():a.removeClass("busy")},"json"))}).ready(function(){$("#pin-enter").length&&($("#pin").focus().keydown(function(){$(".red").html("&nbsp;")}).keyEnter(pinEnter),
$(".vkButton").click(pinEnter));$("#client").length&&(window.cFind=$("#find")._search({width:602,focus:1,enter:1,txt:"Начните вводить данные клиента",func:clientSpisokLoad}),$("#buttonCreate").vkHint({msg:'<B>Внесение нового клиента в базу.</B><br /><br />После внесения Вы попадаете на страницу с информацией о клиенте для дальнейших действий.<br /><br />Клиентов также можно добавлять при <A href="'+URL+'&p=zayav&d=add&back=client">создании новой заявки</A>.',ugol:"right",width:215,top:-38,left:-250,
indent:40,delayShow:1E3,correct:0}).click(clientAdd),$("#dolg")._check(clientSpisokLoad),$("#dolg_check").vkHint({msg:"<b>Список должников.</b><br /><br />Выводятся клиенты, у которых баланс менее 0. Также в результате отображается общая сумма долга.",ugol:"right",width:150,top:-6,left:-185,indent:20,delayShow:1E3,correct:0}));$("#clientInfo").length&&($("#dopLinks .link").click(function(){$("#dopLinks .link").removeClass("sel");$(this).addClass("sel");var a=$(this).attr("val");$(".res").css("display",
"zayav"==a?"block":"none");$("#zayav_filter").css("display","zayav"==a?"block":"none");$("#zayav_spisok").css("display","zayav"==a?"block":"none");$("#income_spisok").css("display","money"==a?"block":"none");$("#remind_spisok").css("display","remind"==a?"block":"none");$("#comments").css("display","comm"==a?"block":"none");$("#histories").css("display","hist"==a?"block":"none")}),$(".cedit").click(function(){function a(){var d={op:"client_edit",client_id:CLIENT.id,fio:$("#fio").val(),telefon:$("#telefon").val(),
adres:$("#adres").val(),pasp_seria:$("#pasp_seria").val(),pasp_nomer:$("#pasp_nomer").val(),pasp_adres:$("#pasp_adres").val(),pasp_ovd:$("#pasp_ovd").val(),pasp_data:$("#pasp_data").val()};d.fio?(b.process(),$.post(AJAX_MAIN,d,function(a){a.success?(CLIENT=a,$(".left:first").html(a.html),b.close(),_msg("Данные клиента изменены.")):b.abort()},"json")):(b.bottom.vkHint({msg:'<span class="red">Не указано имя клиента.</span>',top:-47,left:100,indent:50,show:1,remove:1}),$("#fio").focus())}var b=_dialog({head:"Редактирование данных клиента",
top:30,width:380,content:'<table class="client-add"><tr><td class="label">Имя:<td><input type="text" id="fio" maxlength="100" value="'+CLIENT.fio+'"><tr><td class="label">Телефон:<td><input type="text" id="telefon" maxlength="100" value="'+CLIENT.telefon+'"><tr><td class="label">Адрес:<td><input type="text" id="adres" maxlength="100" value="'+CLIENT.adres+'"><tr><td><td><b>Паспортные данные:</b><tr><td class="label">Серия:<td><input type="text" id="pasp_seria" maxlength="8" value="'+CLIENT.pasp_seria+
'"><span class="label">Номер:</span><input type="text" id="pasp_nomer" maxlength="10" value="'+CLIENT.pasp_nomer+'"><tr><td class="label">Прописка:<td><input type="text" id="pasp_adres" maxlength="100" value="'+CLIENT.pasp_adres+'"><tr><td class="label">Кем выдан:<td><input type="text" id="pasp_ovd" maxlength="100" value="'+CLIENT.pasp_ovd+'"><tr><td class="label">Когда выдан:<td><input type="text" id="pasp_data" maxlength="100" value="'+CLIENT.pasp_data+'"></table>',butSubmit:"Сохранить",submit:a});
$("#fio,#telefon,#adres,#pasp_seria,#pasp_nomer,#pasp_adres,#pasp_ovd,#pasp_data").keyEnter(a)}),$(".cdel").click(function(){var a=_dialog({top:90,width:300,head:"Удаление клиента",content:"<center>Внимание!<br />Будут удалены все данные о клиенте,<br />его заявки, платежи и задачи.<br /><b>Подтвердите удаление.</b></center>",butSubmit:"Удалить",submit:function(){var b={op:"client_del",id:CLIENT.id};a.process();$.post(AJAX_MAIN,b,function(b){b.success?(a.close(),_msg("Клиент удален!"),location.href=
URL+"&p=client"):a.abort()},"json")}})}),$("#status").rightLink(clientZayavSpisokLoad));if($("#zayav").length){window.zFind=$("#find")._search({width:153,focus:1,txt:"Быстрый поиск...",enter:1,func:zayavFindFast});$("#status").rightLink(zayavSpisok);for(var a=[],b=0;b<PRODUCT_IDS.length;b++){var c=PRODUCT_IDS[b];a.push({uid:c,title:PRODUCT_ASS[c]})}$("#product_id")._select({width:155,title0:"Любые изделия",spisok:a,func:zayavSpisok})}$(".zayav-info").length&&($(".zinfo").click(function(){$(this).parent().find(".sel").removeClass("sel");
