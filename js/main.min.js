...
$.post(AJAX_MAIN,a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},incomeChoiceSum=function(){var a,b=$("._money .choice"),c=0,d=0,f=!0,e=[];for(a=0;a<b.length;a++){var g=b.eq(a);1==g.find("input").val()?(c++,d+=1*g.parent().find(".sum").html().replace(" ",""),e.push(g.parent().attr("val"))):f=!1}$(".income_choice_sum").html(c?"Выбрано <b>"+c+"</b> платеж"+_end(c,["","а","ей"])+" на сумму <b>"+d+"</b> руб.":"");$("#money_all")._check(f);
return{count:c,ids:e.join(),sum:d}},expenseFilter=function(){for(var a=[],b=$("#monthList input"),c=1;12>=c;c++)1==b.eq(c-1).val()&&a.push(c);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},
"json")};
$.fn.clientSel=function(a){function b(d){d={op:"client_sel",val:d||"",client_id:a.client_id};c._select("process");$.post(AJAX_MAIN,d,function(d){c._select("cancel");d.success&&(c._select(d.spisok),a.client_id&&(c._select(a.client_id),a.client_id=0))},"json")}var c=$(this);a=$.extend({width:270,add:null,client_id:c.val()||0,func:function(){}},a);a.add&&(a.add=function(){clientAdd(function(a){var b=[];b.push(a);c._select(b);c._select(a.uid)})});c._select({width:a.width,title0:"Начните вводить данные клиента...",spisok:[],
write:1,nofind:"Клиентов не найдено",func:a.func,funcAdd:a.add,funcKeyup:b});b();return c};
