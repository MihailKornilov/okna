...
c+'" value="'+d[c]+'">';$("#preview-form").html(b).submit()}});$("#reason").autosize()},expenseSpisok=function(){var a={op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),year:$("#year").val(),month:$("#monthSum").val()};$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,a,function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")},setupRulesSet=function(a,b){$.post(AJAX_MAIN,{op:"setup_rules_set",viewer_id:RULES_VIEWER_ID,
value:b,action:a},function(){},"json")};
...
$.fn.productList=function(a){function b(a){var d=e+g,b=d+"id",f=d+"subid",k=d+"count";l.before('<table id="ptab'+g+'" class="ptab" val="'+g+'"><tr><td class="td"><input type="hidden" id="'+b+'" value="'+(a[0]||0)+'" /><input type="hidden" id="'+f+'" value="'+(a[1]||0)+'" /><td class="td"><input type="text" id="'+k+'" value="'+(a[2]||"")+'" class="count" maxlength="3" /> шт.'+(1<g?'<div class="img_del"></div>':"")+"</table>");var h=$("#ptab"+g);h.find(".img_del").click(function(){h.remove()});$("#"+
b)._select({width:119,title0:"Не указано",spisok:PRODUCT_SPISOK,func:function(a){$("#"+f)._select("remove").val(0);0<a&&PRODUCT_SUB_SPISOK[a]&&c(a,f,k);$("#"+k).val(0<a?1:"").focus()}});c(a[0]||0,f,k);g++}function c(a,d,b){0!=a&&PRODUCT_SUB_SPISOK[a]&&$("#"+d)._select({width:120,title0:"Подвид не указан",spisok:PRODUCT_SUB_SPISOK[a],func:function(){$("#"+b).focus()}})}var d=$(this),e=d.attr("id"),g=1,f;if("string"==typeof a&&"get"==a){a=d.find(".ptab");d=[];for(f=0;f<a.length;f++){var k=a.eq(f),h=
...
submit:function(){var a,e={op:"set_add",client_id:$("#client_id").val(),product:$("#product").productList("get"),adres:$("#adres").val(),comm:$("#comm").val()};0==e.client_id?a="Не выбран клиент":e.product?"count_error"==e.product?a="Некорректно введено количество изделий":e.adres?(b.process(),$.post(AJAX_MAIN,e,function(a){a.success?(b.close(),_msg("Заявка внесена"),location.href=URL+"&p=zayav&d=info&id="+a.id):b.abort()},"json")):a="Не указан адрес":a="Не указано изделие";a&&b.bottom.vkHint({msg:'<SPAN class="red">'+
...
top:-75,left:163,indent:60,delayShow:400})}));$("#remind").length&&($(".goyear").click(function(){$("#remind").addClass("y")}),window._calendarFilter=function(a){var b=$("#remind").hasClass("y"),c=$("#remind .right ._calendarFilter");a={op:"remind_day",day:a};b&&$("#remind").removeClass("y");$.post(AJAX_MAIN,a,function(a){a.success&&($("#remind .left").html(a.html),b&&c.html(a.cal))},"json")});$("#income").length&&(window._calendarFilter=function(a){send={op:"income_get",day:a};$.post(AJAX_MAIN,send,
function(a){a.success&&($("#income .inc-path").html(a.path),$("#income #spisok").html(a.html))},"json")});$("#report.expense").length&&($(".add").click(function(){function a(c){b.bottom.vkHint({msg:'<SPAN class="red">'+c+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var b=_dialog({width:380,head:"Внесение расхода",content:'<table id="expense-add-tab"><tr><td class="label">Категория:<TD><INPUT type="hidden" id="cat"><tr class="tr-work dn"><td class="label">Сотрудник:<TD><INPUT type="hidden" id="work"><tr><td class="label">Описание:<TD><INPUT type="text" id="about" maxlength="100"><tr><td class="label">Со счёта:<TD><INPUT type="hidden" id="invoice"><tr><td class="label">Сумма:<TD><INPUT type="text" id="sum" class="money" maxlength="8"> руб.</table>',
submit:function(){var c={op:"expense_add",category:1*$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val()};c.category||c.about?c.invoice?REGEXP_NUMERIC.test(c.sum)?(b.process(),$.post(AJAX_MAIN,c,function(a){a.success?(b.close(),_msg("Новый расход внесён."),expenseSpisok()):b.abort()},"json")):(a("Некорректно указана сумма."),$("#sum").focus()):a("Укажите с какого счёта производится оплата."):(a("Выберите категорию или укажите описание."),
$("#about").focus())}});$("#cat")._select({width:180,title0:"Не указана",spisok:EXPENSE_SPISOK,func:function(a){$("#work")._select(0);$(".tr-work")[(EXPENSE_WORKER_ASS[a]?"remove":"add")+"Class"]("dn")}});$("#about").focus();$("#work")._select({title0:"Не выбран",spisok:WORKER_SPISOK});$("#invoice")._select({title0:"Не выбран",spisok:INVOICE_SPISOK,func:function(){$("#sum").focus()}})}),$("#category")._select({width:160,title0:"Любая категория",spisok:EXPENSE_SPISOK,func:expenseSpisok}),$("#worker")._select({width:160,
title0:"Все сотрудники",spisok:WORKERS,func:expenseSpisok}),$("#year").years({func:expenseSpisok}),$("#monthSum")._radio(expenseSpisok));$("#setup_rules").length&&($(".gtab-save").click(function(){function a(b){c.vkHint({msg:'<SPAN class="red">'+b+"</SPAN>",top:-57,left:-6,indent:40,show:1,remove:1})}var b={op:"setup_worker_save",viewer_id:RULES_VIEWER_ID,first_name:$("#first_name").val(),last_name:$("#last_name").val(),post:$("#post").val()},c=$(this);b.first_name?b.last_name?(c.addClass("busy"),
$.post(AJAX_MAIN,b,function(a){c.removeClass("busy");a.success&&_msg("Сохранено.")},"json")):(a("Не указана фамилия"),$("#last_name").focus()):(a("Не указано имя"),$("#first_name").focus())}),$(".pin-clear").click(function(){var a={op:"setup_worker_pinclear",viewer_id:RULES_VIEWER_ID},b=$(this);b.addClass("busy");$.post(AJAX_MAIN,a,function(a){b.removeClass("busy");a.success&&_msg("Пин-код сброшен.")},"json")}),$("#rules_appenter")._check(function(a,b){$(".app-div")[(0==a?"add":"remove")+"Class"]("dn");
setupRulesSet(a,b);$("#rules_worker")._check(0);$("#rules_product")._check(0);$("#rules_income")._check(0);$("#rules_zayavrashod")._check(0);$("#rules_historyshow")._check(0)}),$("#rules_worker")._check(setupRulesSet),$("#rules_rekvisit")._check(setupRulesSet),$("#rules_product")._check(setupRulesSet),$("#rules_income")._check(setupRulesSet),$("#rules_zayavrashod")._check(setupRulesSet),$("#rules_historyshow")._check(setupRulesSet));$("#setup_rekvisit").length&&$(".vkButton").click(function(){var a=
$(this),b={op:"setup_rekvisit",org_name:$("#org_name").val(),ogrn:$("#ogrn").val(),inn:$("#inn").val(),kpp:$("#kpp").val(),yur_adres:$("#yur_adres").val(),telefon:$("#telefon").val(),ofice_adres:$("#ofice_adres").val()};a.addClass("busy");$.post(AJAX_MAIN,b,function(b){a.removeClass("busy");b.success&&_msg("Информация сохранена.")},"json")})});
