...
VALUES+"&worker_id="+WORKER_ID+"&ids="+a)}).on("click",".salary .zp_del",function(){var a=$(this),b=_dialog({top:110,width:250,head:"Удаление з/п",content:"<CENTER>Подтвердите удаление записи.</CENTER>",butSubmit:"Удалить",submit:function(){var c={op:"expense_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(a){a.success?(b.close(),_msg("Удалено."),salarySpisok()):b.abort()},"json")}})}).on("click",".salary .ze_del",function(){for(var a=$(this),b=_dialog({top:110,width:250,head:"Удаление",
content:"<CENTER>Подтвердите удаление записи.</CENTER>",butSubmit:"Удалить",submit:function(){var c={op:"salary_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(a){a.success?(b.close(),_msg("Удалено."),salarySpisok()):b.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).ready(function(){$("#pin-enter").length&&($("#pin").focus().keydown(function(){$(".red").html("&nbsp;")}).keyEnter(pinEnter),$(".vkButton").click(pinEnter));$("#client").length&&(window.cFind=$("#find")._search({width:602,
