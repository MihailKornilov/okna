...
left:84,indent:50,show:1,remove:1}):(DOG.cut=a.join(),h(),r.close())}function h(){var a=DOG.cut?DOG.cut.split(",").length:0;$("#cut").html(a?"Указан"+_end(a,["а","ы"])+" дат"+_end(a,["а","ы"])+" для "+a+_end(a,["-го","-х","-и"])+" платеж"+_end(a,["а","ей"])+'. <u>Изменить</u><div class="img_del'+_tooltip("Отменить разбивку",-61)+"</div>":m);a&&$("#cut .img_del").click(function(a){a.stopPropagation();DOG.cut="";$("#cut").html(m)})}function g(a,b,c){s.bottom.vkHint({msg:'<span class="red">'+a+"</span>",
top:c?-86:-47,left:c?173:142,indent:50,show:1,remove:1});b&&$("#"+b).focus()}var f,k="Заключение",q="Заключить договор",m="Указать даты очередных платежей",l,r,p;switch(a){default:a="create";case "create":break;case "edit":k="Изменение данных";q="Применить";break;case "reneg":k="Перезаключение",q="Перезаключить договор"}var s=_dialog({width:480,top:10,head:k+" договора",content:'<table class="zayav-dogovor"><tr><td class="label">Фио клиента:<td><input type="text" id="fio" value="'+DOG.fio+'" /><tr><td class="label">Адрес:<td><input type="text" id="adres" value="'+
...
$("#preview-form").html(c).submit()}});$("#reason").autosize()},remindSpisok=function(a){var b=$("#remind").hasClass("y"),c=$("#remind .right ._calendarFilter");a={op:"remind_spisok",day:c.find(".selected").val(),status:$("#status").val(),"private":$("#private").val()};b&&$("#remind").removeClass("y");$.post(AJAX_MAIN,a,function(a){a.success&&($(".remind_spisok").html(a.html),b&&c.html(a.cal))},"json")},historyFilter=function(){return{op:"history_spisok",limit:$("#history_limit").val(),worker_id:$("#history_worker_id").val(),
...
a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")},salaryCheck=function(){var a=$("._check"),b,c,d="&nbsp;",e=0,h=0,g=[];for(b=0;b<a.length;b++)c=a.eq(b),"salary_all_check"!=c.attr("id")&&0!=c.find("input").val()&&(e++,c=c.parent().parent(),g.push(c.attr("val")),h+=1*c.find(".sum").html());e&&(d="Выбран"+_end(e,["а","о"])+" <b>"+e+"</b> запис"+_end(e,["ь","и","ей"])+' на сумму <b id="salary-sum">'+h+'</b> руб.<a class="salary-list-create" val="'+g.join()+'">Создать лист выдачи з/п</a>');
$("#salary-sel").html(d)},salarySpisok=function(){if(!$(".headName").hasClass("_busy")){var a={op:"salary_spisok",worker_id:WORKER_ID,year:$("#year").val(),mon:$("#salmon").val()};$(".headName").addClass("_busy");$.post(AJAX_MAIN,a,function(b){$(".headName").removeClass("_busy");b.success&&(MON=1*a.mon,YEAR=a.year,$(".headName em").html(MONTH_DEF[MON]+" "+YEAR),$("#spisok").html(b.html),$("#monthList").html(b.month))},"json")}};
...
e+f.attr("val"),f=$("#"+k+"id").val(),q=$("#"+k+"subid").val(),k=$("#"+k+"count").val();if(0!=f){if(!REGEXP_NUMERIC.test(k)||0==k)return"count_error";d.push(f+":"+q+":"+k)}}return 0==d.length?!1:d.join()}d.html('<div class="_product-list"><a class="add">Добавить поле</a></div>');var m=d.find(".add");m.click(b);if("object"==typeof a)for(g=0;g<a.length;g++)b(a[g]);else b([]);return d};
$.fn.zayavExpense=function(a){function b(a){a||(a=[0,"","",0,0,0,0]);var c=d+e,h=c+"cat",g=c+"worker",f=c+"acc",k=c+"mon",q=c+"year",c=c+"list",c='<table id="ptab'+e+'" class="ptab" val="'+e+'"><tr><td><input type="hidden" id="'+h+'" value="'+a[0]+'" /><td class="tddop">'+(a[0]&&ZAYAVEXPENSE_TXT[a[0]]?'<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*e-1)+'" value="'+a[1]+'" />':"")+(a[0]&&ZAYAVEXPENSE_WORKER[a[0]]?'<input type="hidden" id="'+g+'" value="'+a[1]+'" />':
"")+'<td class="tdsum'+(a[0]?"":" dn")+'"><input type="text" class="zrsum" maxlength="6"'+(a[6]?" disabled":"")+' tabindex="'+10*e+'" value="'+a[2]+'" />руб.<td class="tdacc'+(a[0]&&ZAYAVEXPENSE_WORKER[a[0]]&&a[1]?"":" dn")+'"><input type="hidden" id="'+f+'" value="'+a[3]+'" /><td class="tdmon'+(a[3]?"":" dn")+'"><input type="hidden" id="'+k+'" value="'+(a[4]||(new Date).getMonth()+1)+'" /><input type="hidden" id="'+q+'" value="'+(a[5]||(new Date).getFullYear())+'" /><input type="hidden" id="'+c+
'" value="'+a[6]+'" /></table>';s.append(c);var m=$("#ptab"+e),l=m.find(".tddop"),p=m.find(".zrsum"),r=m.find(".tdacc"),t=m.find(".tdmon");$("#"+h)._select({width:120,disabled:a[6],title0:"Категория",spisok:ZAYAVEXPENSE_SPISOK,func:function(a){m.find(".tdsum")[(0<a?"remove":"add")+"Class"]("dn");ZAYAVEXPENSE_TXT[a]?(l.html('<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*e-11)+'" />'),l.find(".zrtxt").focus()):(ZAYAVEXPENSE_WORKER[a]?(l.html('<input type="hidden" id="'+
g+'" />'),$("#"+g)._select({width:150,title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){p.focus();r[(a?"remove":"add")+"Class"]("dn");$("#"+f)._check(0);t.addClass("dn")}})):l.html(""),p.focus());p.val("");0<a&&!m.next().hasClass("ptab")&&b();r.addClass("dn");$("#"+f)._check(0);t.addClass("dn")}});a[0]&&ZAYAVEXPENSE_WORKER[a[0]]&&$("#"+g)._select({width:150,disabled:a[6],title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){p.focus();r[(a?"remove":"add")+"Class"]("dn");$("#"+f)._check(0);
t.addClass("dn")}});$("#"+f)._check({disabled:a[6],func:function(a){t[(a?"remove":"add")+"Class"]("dn")}});a[6]||$("#"+f+"_check").vkHint({msg:"Начислить",top:-58,left:-28,delayShow:1E3});$("#"+k)._dropdown({disabled:a[6],spisok:u});$("#"+q)._dropdown({disabled:a[6],spisok:[{uid:2014,title:2014}]});e++}var c=$(this),d=c.attr("id"),e=1,h;if("string"==typeof a&&"get"==a){a=c.find(".ptab");c=[];for(h=0;h<a.length;h++){var g=a.eq(h),f=d+g.attr("val"),k=$("#"+f+"cat").val(),q=g.find(".zrsum").val(),m=
"",l=0,r=0,p=0;if(0!=k){if(!REGEXP_NUMERIC.test(q)||0==q)return"sum_error";ZAYAVEXPENSE_TXT[k]?m=g.find(".zrtxt").val():ZAYAVEXPENSE_WORKER[k]&&(m=$("#"+f+"worker").val(),l=$("#"+f+"acc").val(),1==l&&(r=$("#"+f+"mon").val(),p=$("#"+f+"year").val()));c.push(k+":"+m+":"+q+":"+l+":"+r+":"+p+":"+$("#"+f+"list").val())}}return c.join()}c.html('<div class="_zayav-rashod"></div>');var s=c.find("._zayav-rashod"),u=[];for(h in MONTH_DEF)u.push({uid:h,title:MONTH_DEF[h]});if("object"==typeof a)for(h=0;h<a.length;h++)b(a[h]);
b();return c};
$(document).on("change","._attach input",function(){setCookie("_attached",0);for(var a=$(this);!a.hasClass("_attach");)a=a.parent();var b=a.find("form"),c=a.find(".form"),d=setInterval(function(){var e=getCookie("_attached");0<e&&(clearInterval(d),1==e?(e={op:"attach_get",type:b.find(".type").val(),zayav_id:b.find(".zayav_id").val()},$.post(AJAX_MAIN,e,function(e){c.removeClass("_busy");e.success&&(a.find(".files").html(e.files),b.html(e.form))},"json")):(c.removeClass("_busy"),c.next(".red").remove(),c.after('<div class="red">Некорректный файл.</div>'),
c.next(".red").fadeOut(4E3)))},500);c.addClass("_busy");b.submit()}).on("click","._attach .img_minidel",function(){var a=$(this),b={op:"attach_del",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){b.success&&(a.prev().remove(),a.remove())},"json")}).on("click",".accrual-del",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();if(!a.hasClass("deleting")){a.addClass("deleting");var b={op:"accrual_del",id:a.attr("val")};$.post(AJAX_MAIN,b,function(c){a.removeClass("deleting");c.success&&(a.after('<tr class="deleted" val="'+
b.id+'"><td colspan="4"><div>Начисление удалено. <a class="accrual-rest">Восстановить</a></div>'),a.addClass("dn"))},"json")}}).on("click",".accrual-rest",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();var b={op:"accrual_rest",id:a.attr("val")},c=a.find("div");c.hasClass("_busy")||(c.addClass("_busy"),$.post(AJAX_MAIN,b,function(b){c.removeClass("busy");b.success&&(a.prev().removeClass("dn"),a.remove())},"json"))}).on("click","#client ._next",function(){var a=$(this),b=clientFilter();
a.hasClass("busy")||(b.page=a.attr("val"),a.addClass("busy"),$.post(AJAX_MAIN,b,function(b){b.success?a.after(b.spisok).remove():a.removeClass("busy")},"json"))}).on("click",".zayav_add",function(){_dialog({width:370,top:30,head:"Выберите категорию заявки",content:'<div class="zayav-add"><div class="item zakaz_add"><b>Заказ</b>Новый заказ для продажи изделий без установки.<br />При необходимости в будущем заказ можно будет перевести в Установку.</div><div class="item zamer_add"><b>Замер</b>Новая заявка на замер. Указывается дата и время замера. Заявка автоматически попадает в напоминания. Успешный замер переносится на заключение договора.</div><div class="item set_add"><b>Установка</b>Новая заявка на установку изделий.</div>',
...
"json"))})}).on("click",".refund-del",function(){for(var a=$(this),b=_dialog({top:110,width:250,head:"Удаление",content:"<CENTER>Подтвердите удаление возврата.</CENTER>",butSubmit:"Удалить",submit:function(){var c={op:"refund_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(a){a.success?(b.close(),_msg("Удалено."),$("#income_spisok").html(a.html)):b.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).on("click",".remind-add",function(){var a=_dialog({top:40,width:420,head:"Внесение нового напоминания",
...
a.parent();if(!a.hasClass("deleting")){a.addClass("deleting");var b={op:"income_del",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){a.removeClass("deleting");b.success&&a.addClass("deleted")},"json")}}).on("click",".income-rest",function(){for(var a=$(this);"TR"!=a[0].tagName;)a=a.parent();var b={op:"income_rest",id:a.attr("val")};$.post(AJAX_MAIN,b,function(b){b.success&&a.removeClass("deleted")},"json")}).on("click","#income_next",function(){var a=$(this),b={op:"income_next",page:$(this).attr("val"),
...
c+"</SPAN>",top:-48,left:123,indent:40,remove:1,show:1})}var b=_dialog({width:420,head:"Начисление",content:'<table class="accrual-add"><tr><td class="label">Сумма: <td><input type="text" id="sum" class="money" maxlength="11" /> руб.<tr><td class="label">Примечание:<em>(не обязательно)</em><td><input type="text" id="prim" maxlength="100" /></table>',submit:a});$("#sum").focus();$("#sum,#prim").keyEnter(a)}),$(".delete").click(function(){var a=_dialog({top:110,width:250,head:"Удаление заявки",content:"<CENTER>Подтвердите удаление заявки.</CENTER>",
butSubmit:"Удалить",submit:function(){var b={op:"zayav_delete",zayav_id:ZAYAV.id};a.process();$.post(AJAX_MAIN,b,function(a){a.success&&(location.href=URL+"&p=client&d=info&id="+a.client_id)},"json")}})}),$(".expense-edit").click(function(){var a=_dialog({width:510,top:30,head:"Изменение расходов заявки",content:'<table class="zayav-expense-edit"><tr><td class="label">Заявка: <td><b>'+ZAYAV.head+'</b><tr><td class="label topi">Расходы:<td><tr><td colspan="2" id="zrs"></table>',butSubmit:"Сохранить",
submit:function(){var b={op:"zayav_expense_edit",zayav_id:ZAYAV.id,rashod:$("#zrs").zayavExpense("get")};"sum_error"==b.rashod?a.bottom.vkHint({msg:'<SPAN class="red">Некорректно указана сумма</SPAN>',top:-47,left:167,indent:40,show:1,remove:1}):(a.process(),$.post(AJAX_MAIN,b,function(b){b.success?($(".zrashod").html(b.html),ZAYAV.rashod=b.array,a.close(),_msg("Сохранено.")):a.abort()},"json"))}});$("#zrs").zayavExpense(ZAYAV.rashod)}),$(".zakaz-to-set").click(function(){function a(){var c={op:"zakaz_to_set",
...
ZAYAV.adres+'" /><INPUT type="hidden" id="homeadres" /></table>',butSubmit:"Перенести",submit:a});$("#adres").focus().keyEnter(a);$("#homeadres")._check({func:function(){$("#adres").val(ZAYAV.client_adres)}});$("#homeadres_check").vkHint({msg:"Совпадает с адресом проживания клиента",top:-75,left:163,indent:60,delayShow:400})}),$(".refund-add").click(function(){function a(){var c={op:"refund_add",zayav_id:ZAYAV.id,invoice_id:$("#invoice_id").val(),sum:$("#sum").val(),prim:$.trim($("#prim").val())};
0==c.invoice_id?b("Не указан счёт"):REGEXP_CENA.test(c.sum)?(d.process(),$.post(AJAX_MAIN,c,function(a){d.abort();a.success&&(d.close(),_msg("Возврат успешно произведён."),$("#income_spisok").html(a.html))},"json")):(b("Некорректно указана сумма"),$("#sum").focus())}function b(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",top:-48,left:100,indent:40,remove:1,show:1})}var c='<table class="refund-add-tab"><tr><td class="label">Клиент:<td>'+OPL.client_fio+'<tr><td class="label">Со счёта:<TD><INPUT type="hidden" id="invoice_id"><a href="'+
URL+'&p=setup&d=invoice" class="img_edit'+_tooltip("Настройка счетов",-56)+'</a><tr><td class="label">Сумма: <td><input type="text" id="sum" class="money" maxlength="11" /> руб.<tr><td class="label">Комментарий:<td><input type="text" id="prim" maxlength="100" /></table>',d=_dialog({width:370,head:"Возврат",content:c,submit:a});$("#sum").focus();$("#sum,#prim").keyEnter(a);$("#invoice_id")._select({title0:"Не выбран",spisok:INVOICE_SPISOK,func:function(){$("#sum").focus()}})}));$("#remind").length&&
($(".goyear").click(function(){$("#remind").addClass("y")}),window._calendarFilter=remindSpisok,$("#status")._radio(remindSpisok),$("#private")._check(remindSpisok));$("#report.history").length&&($("#worker_id")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:historySpisok}),$("#cat_id")._select({width:160,title0:"Любая категория",spisok:HISTORY_GROUP,func:historySpisok}));$("#report.income").length&&(window._calendarFilter=incomeSpisok,$("#income_id")._select({width:160,title0:"Любые платежи",
spisok:INCOME_SPISOK,func:incomeSpisok}),window.WORKERS&&$("#worker_id")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:incomeSpisok}),$("#deleted")._check(incomeSpisok));$("#report.expense").length&&($(".add").click(function(){function a(){var c={op:"expense_add",category:1*$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val(),mon:$("#tabmon").val(),year:$("#tabyear").val()};c.category||c.about?c.invoice?REGEXP_CENA.test(c.sum)&&
0!=c.sum?(d.process(),$.post(AJAX_MAIN,c,function(a){a.success?(d.close(),_msg("Новый расход внесён."),expenseSpisok()):d.abort()},"json")):(b("Некорректно указана сумма."),$("#sum").focus()):b("Укажите с какого счёта производится оплата."):(b("Выберите категорию или укажите описание."),$("#about").focus())}function b(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var c='<table id="expense-add-tab"><tr><td class="label">Категория:<TD><INPUT type="hidden" id="cat"><a href="'+
