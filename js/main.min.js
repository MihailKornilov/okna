...
if(a){a.op="dogovor_preview";var c="",e;for(e in a)c+='<input type="hidden" name="'+e+'" value="'+a[e]+'">';$("#preview-form").html(c).submit()}});$("#reason").autosize()},zayavInfoMoneyUpdate=function(){$.post(AJAX_MAIN,{op:"zayav_info_money_update",zayav_id:ZAYAV.id},function(a){a.success&&($("b.acc").html(a.acc),$(".acc_tr")[(a.acc?"remove":"add")+"Class"]("dn"),$("b.opl").html(a.opl),$(".opl_tr")[(a.opl?"remove":"add")+"Class"]("dn"),$(".dopl")[(a.dolg?"remove":"add")+"Class"]("dn").html((0<a.dolg?
"+":"")+a.dolg),$(".acc-sum").html(0!=a.acc?"Общая сумма начислений: <b>"+a.acc+"</b> руб.":"Начислений нет."),$(".zrashod").html(a.expense))},"json")},remindSpisok=function(a){var b=$("#remind").hasClass("y"),c=$("#remind .right ._calendarFilter");a={op:"remind_spisok",day:c.find(".selected").val(),status:$("#status").val(),"private":$("#private").val()};b&&$("#remind").removeClass("y");$.post(AJAX_MAIN,a,function(a){a.success&&($(".remind_spisok").html(a.html),b&&c.html(a.cal))},"json")},incomeSpisok=
function(){var a={op:"income_spisok",day:$(".selected").val(),income_id:$("#income_id").val(),worker_id:window.WORKERS?$("#worker_id").val():0,deleted:$("#deleted").val()};$(".inc-path").addClass("_busy");$.post(AJAX_MAIN,a,function(a){$(".inc-path").removeClass("_busy");a.success&&($(".inc-path").html(a.path),$("#spisok").html(a.html))},"json")},incomeChoiceSum=function(){var a,b=$("._money .choice"),c=0,d=0,e=!0,g=[];for(a=0;a<b.length;a++){var f=b.eq(a);1==f.find("input").val()?(c++,d+=1*f.parent().find(".sum").html().replace(" ",
""),g.push(f.parent().attr("val"))):e=!1}$(".income_choice_sum").html(c?"Выбран"+_end(c,["","о"])+" <b>"+c+"</b> платеж"+_end(c,["","а","ей"])+" на сумму <b>"+d+"</b> руб.":"");$("#money_all")._check(e);return{count:c,ids:g.join(),sum:d}},expenseFilter=function(){for(var a=[],b=$("#monthList input"),c=1;12>=c;c++)1==b.eq(c-1).val()&&a.push(c);return{op:"expense_spisok",category:$("#category").val(),worker:$("#worker").val(),invoice_id:$("#invoice_id").val(),year:$("#year").val(),month:a.join()}},
expenseSpisok=function(){$("#mainLinks").addClass("busy");$.post(AJAX_MAIN,expenseFilter(),function(a){$("#mainLinks").removeClass("busy");a.success&&($("#spisok").html(a.html),$("#monthList").html(a.mon))},"json")},salaryCheck=function(){var a=$("._check"),b,c,d="&nbsp;",e=0,g=0,f=[];for(b=0;b<a.length;b++)c=a.eq(b),"salary_all_check"!=c.attr("id")&&0!=c.find("input").val()&&(e++,c=c.parent().parent(),f.push(c.attr("val")),g+=1*c.find(".sum").html());e&&(d="Выбран"+_end(e,["а","о"])+" <b>"+e+"</b> запис"+
_end(e,["ь","и","ей"])+' на сумму <b id="salary-sum">'+g+'</b> руб.<a class="salary-list-create" val="'+f.join()+'">Создать лист выдачи з/п</a>');$("#salary-sel").html(d)},salarySpisok=function(){if(!$(".headName").hasClass("_busy")){var a={op:"salary_spisok",worker_id:WORKER_ID,year:$("#year").val(),mon:$("#salmon").val()};$(".headName").addClass("_busy");$.post(AJAX_MAIN,a,function(b){$(".headName").removeClass("_busy");b.success&&(MON=1*a.mon,YEAR=a.year,$(".headName em").html(MONTH_DEF[MON]+" "+
YEAR),$("#spisok").html(b.html),$("#monthList").html(b.month))},"json")}},salaryDaysGet=function(a,b){var c={op:"salary_days_get",worker_id:WORKER_ID,mon:a,year:b};$("#days-sel").addClass("_busy");$.post(AJAX_MAIN,c,function(a){$("#days-sel").removeClass("_busy");a.success&&(SALARY_DAYS=a.days)},"json")},dayFirst=function(a,b){var c=(new Date(a,b-1,1)).getDay();return 0==c?7:c},dayCount=function(a,b){b--;0==b&&(b=12,a--);return 32-(new Date(a,b,32)).getDate()};
