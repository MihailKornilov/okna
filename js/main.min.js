...
$.fn.zayavExpense=function(a){function b(a){var c=d+e,h=c+"cat",g=c+"worker",f=c+"acc",k=c+"mon",q=c+"year",c=c+"list",c='<table id="ptab'+e+'" class="ptab" val="'+e+'"><tr><td><input type="hidden" id="'+h+'" value="'+(a[0]||0)+'" /><td class="tddop">'+(a[0]&&ZAYAVEXPENSE_TXT[a[0]]?'<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*e-1)+'" value="'+a[1]+'" />':"")+(a[0]&&ZAYAVEXPENSE_WORKER[a[0]]?'<input type="hidden" id="'+g+'" value="'+a[1]+'" />':"")+'<td class="tdsum'+
(a[0]?"":" dn")+'"><input type="text" class="zrsum" maxlength="6"'+(a[6]?" disabled":"")+' tabindex="'+10*e+'" value="'+(a[2]||"")+'" />руб.<td class="tdacc'+(a[0]&&ZAYAVEXPENSE_WORKER[a[0]]&&0<a[1]?"":" dn")+'"><input type="hidden" id="'+f+'" value="'+a[3]+'" /><td class="tdmon'+(0<a[3]?"":" dn")+'"><input type="hidden" id="'+k+'" value="'+(0<a[3]?a[4]:(new Date).getMonth()+1)+'" /><input type="hidden" id="'+q+'" value="'+(0<a[3]?a[5]:(new Date).getFullYear())+'" /><input type="hidden" id="'+c+'" value="'+
a[6]+'" /></table>';s.append(c);var m=$("#ptab"+e),l=m.find(".tddop"),p=m.find(".zrsum"),r=m.find(".tdacc"),t=m.find(".tdmon");$("#"+h)._select({width:120,disabled:a[6],title0:"Категория",spisok:ZAYAVEXPENSE_SPISOK,func:function(a){m.find(".tdsum")[(0<a?"remove":"add")+"Class"]("dn");ZAYAVEXPENSE_TXT[a]?(l.html('<input type="text" class="zrtxt" placeholder="описание не указано" tabindex="'+(10*e-11)+'" />'),l.find(".zrtxt").focus()):(ZAYAVEXPENSE_WORKER[a]?(l.html('<input type="hidden" id="'+g+'" />'),
$("#"+g)._select({width:150,title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){p.focus();r[(a?"remove":"add")+"Class"]("dn");$("#"+f)._check(0);t.addClass("dn")}})):l.html(""),p.focus());p.val("");0<a&&!m.next().hasClass("ptab")&&b([]);r.addClass("dn");$("#"+f)._check(0);t.addClass("dn")}});a[0]&&ZAYAVEXPENSE_WORKER[a[0]]&&$("#"+g)._select({width:150,disabled:a[6],title0:"Сотрудник",spisok:WORKER_SPISOK,func:function(a){p.focus();r[(a?"remove":"add")+"Class"]("dn");$("#"+f)._check(0);t.addClass("dn")}});
$("#"+f)._check({disabled:a[6],func:function(a){t[(a?"remove":"add")+"Class"]("dn")}});a[6]||$("#"+f+"_check").vkHint({msg:"Начислить",top:-58,left:-28,delayShow:1E3});$("#"+k)._dropdown({disabled:a[6],spisok:u});$("#"+q)._dropdown({disabled:a[6],spisok:[{uid:2014,title:2014}]});e++}var c=$(this),d=c.attr("id"),e=1,h;if("string"==typeof a&&"get"==a){a=c.find(".ptab");c=[];for(h=0;h<a.length;h++){var g=a.eq(h),f=d+g.attr("val"),k=$("#"+f+"cat").val(),m=g.find(".zrsum").val(),q="",l=0,r=0,p=0;if(0!=
k){if(!REGEXP_NUMERIC.test(m)||0==m)return"sum_error";ZAYAVEXPENSE_TXT[k]?q=g.find(".zrtxt").val():ZAYAVEXPENSE_WORKER[k]&&(q=$("#"+f+"worker").val(),l=$("#"+f+"acc").val(),1==l&&(r=$("#"+f+"mon").val(),p=$("#"+f+"year").val()));c.push(k+":"+q+":"+m+":"+l+":"+r+":"+p+":"+$("#"+f+"list").val())}}return c.join()}c.html('<div class="_zayav-rashod"></div>');var s=c.find("._zayav-rashod"),u=[];for(h in MONTH_DEF)u.push({uid:h,title:MONTH_DEF[h]});if("object"==typeof a)for(h=0;h<a.length;h++)b(a[h]);b([]);
return c};
...
butSubmit:"Удалить",submit:function(){var c={op:"salary_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(a){a.success?(b.close(),_msg("Удалено."),salarySpisok()):b.abort()},"json")}});"TR"!=a[0].tagName;)a=a.parent()}).ready(function(){$("#pin-enter").length&&($("#pin").focus().keydown(function(){$(".red").html("&nbsp;")}).keyEnter(pinEnter),$(".vkButton").click(pinEnter));$("#client").length&&(window.cFind=$("#find")._search({width:602,focus:1,enter:1,txt:"Начните вводить данные клиента",
func:clientSpisok}),$("#buttonCreate").vkHint({msg:'<B>Внесение нового клиента в базу.</B><br /><br />После внесения Вы попадаете на страницу с информацией о клиенте для дальнейших действий.<br /><br />Клиентов также можно добавлять при <A href="'+URL+'&p=zayav&d=add&back=client">создании новой заявки</A>.',ugol:"right",width:215,top:-38,left:-250,indent:40,delayShow:1E3,correct:0}).click(clientAdd),$("#dolg")._check(clientSpisok),$("#dolg_check").vkHint({msg:"<b>Список должников.</b><br /><br />Выводятся клиенты, у которых баланс менее 0. Также в результате отображается общая сумма долга.",
ugol:"right",width:150,top:-6,left:-185,indent:20,delayShow:1E3,correct:0}),$("#worker")._check(clientSpisok),$("#note")._check(clientSpisok),$("#zayav_cat")._select({width:140,title0:"Любые заявки",spisok:[{uid:1,title:"Заказы"},{uid:2,title:"Замеры"},{uid:3,title:"Договора"},{uid:4,title:"Установки"}],func:clientSpisok}),$("#product_id")._select({width:140,title0:"Любые изделия",spisok:PRODUCT_SPISOK,func:clientSpisok}));$("#clientInfo").length&&($("#dopLinks .link").click(function(){$("#dopLinks .link").removeClass("sel");
$(this).addClass("sel");var a=$(this).attr("val");$(".res").css("display","zayav"==a?"block":"none");$("#zayav_filter").css("display","zayav"==a?"block":"none");$("#zayav_spisok").css("display","zayav"==a?"block":"none");$("#income_spisok").css("display","money"==a?"block":"none");$(".remind_spisok").css("display","remind"==a?"block":"none");$("#comments").css("display","comm"==a?"block":"none");$("#histories").css("display","hist"==a?"block":"none")}),$(".cedit").click(function(){function a(){var e=
{op:"client_edit",client_id:CLIENT.id,fio:$("#c-fio").val(),telefon:$("#c-telefon").val(),adres:$("#c-adres").val(),worker_id:$("#worker_id").val(),pasp_seria:$("#pasp_seria").val(),pasp_nomer:$("#pasp_nomer").val(),pasp_adres:$("#pasp_adres").val(),pasp_ovd:$("#pasp_ovd").val(),pasp_data:$("#pasp_data").val()};e.fio?(c.process(),$.post(AJAX_MAIN,e,function(a){a.success?(a.workers=CLIENT.workers,CLIENT=a,$(".left:first").html(a.html),c.close(),_msg("Данные клиента изменены.")):(b(a.text),c.abort())},
"json")):(b("Не указано имя клиента"),$("#c-fio").focus())}function b(a){c.bottom.vkHint({msg:'<span class="red">'+a+"</span>",top:-47,left:120,indent:50,show:1,remove:1})}var c=_dialog({head:"Редактирование данных клиента",top:30,width:430,content:'<table class="client-add e"><tr><td class="label">Имя:<td><input type="text" id="c-fio" maxlength="100" value="'+CLIENT.fio+'"><tr><td class="label">Телефон:<td><input type="text" id="c-telefon" maxlength="100" value="'+CLIENT.telefon+'"><tr><td class="label">Адрес:<td><input type="text" id="c-adres" maxlength="100" value="'+
CLIENT.adres+'"><tr><td class="label">Связан с сотрудником:<td><input type="hidden" id="worker_id" value="'+CLIENT.worker_id+'"><tr><td><td><b>Паспортные данные:</b><tr><td class="label">Серия:<td><input type="text" id="pasp_seria" maxlength="8" value="'+CLIENT.pasp_seria+'"><span class="label">Номер:</span><input type="text" id="pasp_nomer" maxlength="10" value="'+CLIENT.pasp_nomer+'"><tr><td class="label">Прописка:<td><input type="text" id="pasp_adres" maxlength="100" value="'+CLIENT.pasp_adres+
'"><tr><td class="label">Кем выдан:<td><input type="text" id="pasp_ovd" maxlength="100" value="'+CLIENT.pasp_ovd+'"><tr><td class="label">Когда выдан:<td><input type="text" id="pasp_data" maxlength="100" value="'+CLIENT.pasp_data+'"></table>',butSubmit:"Сохранить",submit:a});$("#worker_id")._select({width:180,title0:"Не выбран",spisok:CLIENT.workers});$("#c-fio,#c-telefon,#c-adres,#pasp_seria,#pasp_nomer,#pasp_adres,#pasp_ovd,#pasp_data").keyEnter(a)}),$(".cdel").click(function(){var a=_dialog({top:90,
width:300,head:"Удаление клиента",content:"<center>Внимание!<br />Будут удалены все данные о клиенте,<br />его заявки, платежи и задачи.<br /><b>Подтвердите удаление.</b></center>",butSubmit:"Удалить",submit:function(){var b={op:"client_del",id:CLIENT.id};a.process();$.post(AJAX_MAIN,b,function(b){b.success?(a.close(),_msg("Клиент удален!"),location.href=URL+"&p=client"):a.abort()},"json")}})}));if($("#zayav").length){$("#find")._search({width:153,focus:1,txt:"Быстрый поиск...",enter:1,func:zayavFindFast}).vkHint({width:220,
msg:"<b>Быстрый поиск</b> производится одновременно по всем категориям заявок. Учитываются поля: номер договора, номера ВГ, Ж, Д, адрес установки, Фио и телефоны клиентов и порядковый номер заявки. Другие условия фильтра игонрируются.",ugol:"top",indent:"right",delayShow:1E3,top:45,left:384});$("#status").rightLink(zayavSpisok);for(var a=[],b=0;b<PRODUCT_IDS.length;b++){var c=PRODUCT_IDS[b];a.push({uid:c,title:PRODUCT_ASS[c]})}$("#product_id")._select({width:155,title0:"Любые изделия",spisok:a,func:zayavSpisok});
$("#zp_expense")._radio(zayavSpisok);$("#account")._check(zayavSpisok)}$(".zayav-info").length&&($(".zinfo").click(function(){$(this).parent().find(".sel").removeClass("sel");$(this).addClass("sel");$(".zayav-info").removeClass("h")}),$(".hist").click(function(){$(this).parent().find(".sel").removeClass("sel");$(this).addClass("sel");$(".zayav-info").addClass("h")}),$(".dogovor_create").click(dogovorCreate),$(".dogovor_no_require").click(function(){$.post(AJAX_MAIN,{op:"dogovor_no_require",zayav_id:ZAYAV.id},
function(a){a.success&&document.location.reload()},"json")}),$("#dogovor_action")._dropdown({head:"Не заключен",spisok:[{uid:1,title:"Заключить договор"},{uid:2,title:'Перевести заявку в категорию "Требуется договор"'}],nosel:1,func:function(a){1==a&&dogovorCreate();2==a&&$.post(AJAX_MAIN,{op:"dogovor_require",zayav_id:ZAYAV.id},function(a){a.success&&document.location.reload()},"json")}}),$("#dogovor_reaction")._dropdown({head:"Действие",headgrey:1,spisok:[{uid:1,title:"Изменение данных договора"},
{uid:2,title:"Перезаключение"},{uid:3,title:"Расторжение"}],nosel:1,func:function(a){1==a&&dogovorCreate("edit")}}),$(".zakaz_edit").click(function(){function a(){var c,e={op:"zakaz_edit",zayav_id:ZAYAV.id,product:$("#product").productList("get"),zakaz_txt:$("#zakaz_txt").val(),nomer_vg:$("#nomer_vg").val(),nomer_g:$("#nomer_g").val(),nomer_d:$("#nomer_d").val(),nomer_t:$("#nomer_t").val()};e.product||e.zakaz_txt?"count_error"==e.product?c="Некорректно введено количество изделий":(b.process(),$.post(AJAX_MAIN,
e,function(a){a.success?(b.close(),_msg("Данные изменены!"),document.location.reload()):b.abort()},"json")):c="Необходимо выбрать изделие или вписать заказ вручную";c&&b.bottom.vkHint({msg:'<SPAN class="red">'+c+"</SPAN>",top:-47,left:161,indent:40,show:1,remove:1})}var b=_dialog({width:500,top:30,head:ZAYAV.head+" - Редактирование",content:'<table class="zayav-info-edit"><tr><td class="label">Клиент:      <td>'+ZAYAV.client_fio+'<tr><td class="label topi">Изделие:<td id="product"><tr><td><td><input type="text" id="zakaz_txt" placeholder="либо укажите содержание заказа вручную.." maxlength="300" value="'+
...
e.product?"count_error"==e.product?c="Некорректно введено количество изделий":e.adres?(b.process(),$.post(AJAX_MAIN,e,function(a){a.success?(b.close(),_msg("Данные изменены!"),document.location.reload()):b.abort()},"json")):c="Не указан адрес":c="Не указано изделие";c&&b.bottom.vkHint({msg:'<SPAN class="red">'+c+"</SPAN>",top:-47,left:161,indent:40,show:1,remove:1})}var b=_dialog({width:500,top:30,head:ZAYAV.head+" - Редактирование",content:'<table class="zayav-info-edit"><tr><td class="label">Клиент:      <td>'+
...
incomeSpisok,$("#income_id")._select({width:160,title0:"Любые платежи",spisok:INCOME_SPISOK,func:incomeSpisok}),window.WORKERS&&$("#worker_id")._select({width:160,title0:"Все сотрудники",spisok:WORKERS,func:incomeSpisok}),$("#deleted")._check(incomeSpisok));$("#report.expense").length&&($(".add").click(function(){function a(){var c={op:"expense_add",category:1*$("#cat").val(),about:$("#about").val(),worker:$("#work").val(),invoice:1*$("#invoice").val(),sum:$("#sum").val(),mon:$("#tabmon").val(),year:$("#tabyear").val()};
c.category||c.about?c.invoice?REGEXP_CENA.test(c.sum)&&0!=c.sum?(d.process(),$.post(AJAX_MAIN,c,function(a){a.success?(d.close(),_msg("Новый расход внесён."),expenseSpisok()):d.abort()},"json")):(b("Некорректно указана сумма."),$("#sum").focus()):b("Укажите с какого счёта производится оплата."):(b("Выберите категорию или укажите описание."),$("#about").focus())}function b(a){d.bottom.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",remove:1,indent:40,show:1,top:-47,left:101})}var c='<table id="expense-add-tab"><tr><td class="label">Категория:<TD><INPUT type="hidden" id="cat"><a href="'+
