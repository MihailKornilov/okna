var setupRulesSet=function(a,b){$.post(AJAX_MAIN,{op:"setup_rules_set",viewer_id:RULES_VIEWER_ID,value:b,action:a},function(){},"json")};
...
a[0].tagName;)a=a.parent();var c={op:"setup_zayavrashod_del",id:a.attr("val")};b.process();$.post(AJAX_MAIN,c,function(a){a.success?($(".spisok").html(a.html),b.close(),_msg("Удалено!"),sortable()):b.abort()},"json")}})}).ready(function(){$("#setup_rules").length&&($(".gtab-save").click(function(){function a(a){c.vkHint({msg:'<SPAN class="red">'+a+"</SPAN>",top:-57,left:-6,indent:40,show:1,remove:1})}var b={op:"setup_worker_save",viewer_id:RULES_VIEWER_ID,first_name:$("#first_name").val(),last_name:$("#last_name").val(),
...
b){$(".app-div")[(0==a?"add":"remove")+"Class"]("dn");setupRulesSet(a,b);$("#rules_worker")._check(0);$("#rules_product")._check(0);$("#rules_income")._check(0);$("#rules_zayavrashod")._check(0);$("#rules_historyshow")._check(0);$("#rules_money")._check(0);$("#rules_cash")._check(0)}),$("#rules_worker")._check(setupRulesSet),$("#rules_rekvisit")._check(setupRulesSet),$("#rules_product")._check(setupRulesSet),$("#rules_income")._check(setupRulesSet),$("#rules_zayavrashod")._check(setupRulesSet),$("#rules_historyshow")._check(setupRulesSet),
$("#rules_money")._check(setupRulesSet),$("#rules_cash")._check(setupRulesSet));$("#setup_rekvisit").length&&$(".vkButton").click(function(){var a=$(this),b={op:"setup_rekvisit",org_name:$("#org_name").val(),ogrn:$("#ogrn").val(),inn:$("#inn").val(),kpp:$("#kpp").val(),yur_adres:$("#yur_adres").val(),telefon:$("#telefon").val(),ofice_adres:$("#ofice_adres").val()};a.addClass("busy");$.post(AJAX_MAIN,b,function(b){a.removeClass("busy");b.success&&_msg("Информация сохранена.")},"json")})});
