...
a.success&&_msg("Пин-код сброшен.")},"json"))}),$("#rules_appenter")._check(function(a){$(".app-div")[(0==a?"add":"remove")+"Class"]("dn");$("#rules_worker")._check(0);$("#rules_rules")._check(0);$("#rules_rekvisit")._check(0);$("#rules_product")._check(0);$("#rules_income")._check(0);$("#rules_zayavrashod")._check(0);$("#rules_historyshow")._check(0);$("#rules_money")._dropdown(0)}),$("#rules_money")._dropdown({spisok:[{uid:0,title:"только свои"},{uid:1,title:"все платежи"}]}),$(".rules-save").click(function(){var a=
{op:"setup_worker_rules_save",viewer_id:RULES_VIEWER_ID,rules_appenter:$("#rules_appenter").val(),rules_worker:$("#rules_worker").val(),rules_rules:$("#rules_rules").val(),rules_rekvisit:$("#rules_rekvisit").val(),rules_product:$("#rules_product").val(),rules_income:$("#rules_income").val(),rules_zayavrashod:$("#rules_zayavrashod").val(),rules_historyshow:$("#rules_historyshow").val(),rules_money:$("#rules_money").val()},b=$(this);b.hasClass("busy")||(b.addClass("busy"),$.post(AJAX_MAIN,a,function(a){b.removeClass("busy");
a.success&&_msg("Права сохранены.")},"json"))}),$(".dop-save").click(function(){var a={op:"setup_worker_dop_save",viewer_id:RULES_VIEWER_ID,rules_cash:$("#rules_cash").val(),rules_getmoney:$("#rules_getmoney").val(),rules_nosalary:$("#rules_nosalary").val()},b=$(this);b.hasClass("busy")||(b.addClass("busy"),$.post(AJAX_MAIN,a,function(a){b.removeClass("busy");a.success&&_msg("Дополнительные настройки сохранены.")},"json"))}));$("#setup_rekvisit").length&&$(".vkButton").click(function(){var a=$(this),
b={op:"setup_rekvisit",org_name:$("#org_name").val(),ogrn:$("#ogrn").val(),inn:$("#inn").val(),kpp:$("#kpp").val(),yur_adres:$("#yur_adres").val(),telefon:$("#telefon").val(),ofice_adres:$("#ofice_adres").val()};a.addClass("busy");$.post(AJAX_MAIN,b,function(b){a.removeClass("busy");b.success&&_msg("Информация сохранена.")},"json")})});
